...
*/
void _dump_bitfield(std::shared_ptr<_plugin_field> field, std::ofstream& file, std::ostringstream& rout);
void _dump_enum(std::shared_ptr<_plugin_field> field, std::ofstream& file, std::ostringstream& rout);
/*
