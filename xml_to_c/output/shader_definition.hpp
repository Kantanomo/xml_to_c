...
TAG_REFL_TAG_BLOCK_DEF(s_shader_group_definition::s_postprocess_definition_group_definition::s_bitmaps_block)	TAG_REFL_TAG_REFERENCE(bitmap_group)	TAG_REFL_PROPERTY(bitmap_index)	TAG_REFL_PROPERTY(log_bitmap_dimension)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_shader_group_definition::s_postprocess_definition_group_definition::s_pixel_constants_block)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_shader_group_definition::s_postprocess_definition_group_definition::s_vertex_constants_block)	TAG_REFL_PROPERTY(x)	TAG_REFL_PROPERTY(y)	TAG_REFL_PROPERTY(z)	TAG_REFL_PROPERTY(w)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_shader_group_definition::s_postprocess_definition_group_definition::s_levels_of_detail_block)	TAG_REFL_PROPERTY(available_layer_flags)	TAG_REFL_PROPERTY(block_index_data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_shader_group_definition::s_postprocess_definition_group_definition::s_layers_block)	TAG_REFL_PROPERTY(block_index_data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_shader_group_definition::s_postprocess_definition_group_definition::s_passes_block)	TAG_REFL_PROPERTY(block_index_data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_shader_group_definition::s_postprocess_definition_group_definition::s_implementations_block)	TAG_REFL_PROPERTY(bitmap_transforms_block_index_data)	TAG_REFL_PROPERTY(render_states_block_index_data)	TAG_REFL_PROPERTY(texture_states_block_index_data)	TAG_REFL_PROPERTY(pixel_constants_block_index_data)	TAG_REFL_PROPERTY(vertex_constants_block_index_data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_shader_group_definition::s_postprocess_definition_group_definition::s_overlays_block)	TAG_REFL_STRING_ID(input_name)	TAG_REFL_STRING_ID(range_name)	TAG_REFL_PROPERTY(time_period_in_seconds)	TAG_REFL_DATA_BLOCK(function)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_shader_group_definition::s_postprocess_definition_group_definition::s_overlay_references_block)	TAG_REFL_PROPERTY(overlay_index)	TAG_REFL_PROPERTY(transform_index)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_shader_group_definition::s_postprocess_definition_group_definition::s_animated_parameters_block)	TAG_REFL_PROPERTY(block_index_data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_shader_group_definition::s_postprocess_definition_group_definition::s_animated_parameter_references_block)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(parameter_index)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_shader_group_definition::s_postprocess_definition_group_definition::s_bitmap_properties_block)	TAG_REFL_PROPERTY(bitmap_index)	TAG_REFL_PROPERTY(animated_parameter_index)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_shader_group_definition::s_postprocess_definition_group_definition::s_color_properties_block)	TAG_REFL_REAL_COLOR_RGB(color)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_shader_group_definition::s_postprocess_definition_group_definition::s_value_properties_block)	TAG_REFL_PROPERTY(value)REFL_END
