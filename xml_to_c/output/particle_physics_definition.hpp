...
TAG_REFL_TAG_BLOCK_DEF(s_particle_physics_group_definition::s_movements_group_definition::s_parameters_block)	TAG_REFL_PROPERTY(parameter_id)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(unknown)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_physics_group_definition::s_movements_block)	TAG_REFL_PROPERTY(type)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_TAG_BLOCK(parameters)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(unknown)REFL_END
