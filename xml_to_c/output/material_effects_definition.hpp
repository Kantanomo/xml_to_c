...
TAG_REFL_TAG_BLOCK_DEF(s_material_effects_group_definition::s_effects_group_definition::s_old_materials_block)	TAG_REFL_TAG_REFERENCE(effect)	TAG_REFL_TAG_REFERENCE(sound)	TAG_REFL_STRING_ID(material_name)	TAG_REFL_PROPERTY(global_material_index)	TAG_REFL_PROPERTY(sweetener_mode)	TAG_REFL_PROPERTY(unknown)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_material_effects_group_definition::s_effects_group_definition::s_sounds_block)	TAG_REFL_TAG_REFERENCE(tag)	TAG_REFL_TAG_REFERENCE(secondary_tag)	TAG_REFL_STRING_ID(material_name)	TAG_REFL_PROPERTY(global_material_index)	TAG_REFL_PROPERTY(sweetener_mode)	TAG_REFL_PROPERTY(unknown)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_material_effects_group_definition::s_effects_group_definition::s_effects_block)	TAG_REFL_TAG_REFERENCE(tag)	TAG_REFL_TAG_REFERENCE(secondary_tag)	TAG_REFL_STRING_ID(material_name)	TAG_REFL_PROPERTY(global_material_index)	TAG_REFL_PROPERTY(sweetener_mode)	TAG_REFL_PROPERTY(unknown)REFL_END
