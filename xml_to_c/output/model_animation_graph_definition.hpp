...
TAG_REFL_TAG_BLOCK_DEF(s_skeleton_nodes_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_animations_block)
	TAG_REFL_STRING_ID(name)
...
TAG_REFL_TAG_BLOCK_DEF(s_modes|aabbcc_block)
	TAG_REFL_STRING_ID(label)
TAG_REFL_TAG_BLOCK_DEF(s_weapon_class|aabbcc_block)
	TAG_REFL_STRING_ID(label)
TAG_REFL_TAG_BLOCK_DEF(s_weapon_type|aabbcc_block)
	TAG_REFL_STRING_ID(label)
TAG_REFL_TAG_BLOCK_DEF(s_actions|aabbcc_block)
	TAG_REFL_STRING_ID(label)
	TAG_REFL_PROPERTY(graph_index)
	TAG_REFL_PROPERTY(animation_index)
REFL_END
	TAG_REFL_TAG_BLOCK(actions|aabbcc)
TAG_REFL_TAG_BLOCK_DEF(s_overlays|aabbcc_block)
	TAG_REFL_STRING_ID(label)
	TAG_REFL_PROPERTY(graph_index)
	TAG_REFL_PROPERTY(animation_index)
REFL_END
	TAG_REFL_TAG_BLOCK(overlays|aabbcc)
TAG_REFL_TAG_BLOCK_DEF(s_death_and_damage|aabbcc_block)
	TAG_REFL_STRING_ID(label)
TAG_REFL_TAG_BLOCK_DEF(s_directions_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_mode_ik|aabbcc_block)
	TAG_REFL_STRING_ID(marker)
	TAG_REFL_STRING_ID(attach_to_marker)
REFL_END
...
TAG_REFL_TAG_BLOCK_DEF(s_vehicle_suspension|ccaabb_block)
	TAG_REFL_STRING_ID(label)
	TAG_REFL_PROPERTY(graph_index)
	TAG_REFL_PROPERTY(animation_index)
	TAG_REFL_STRING_ID(marker_name)
...
TAG_REFL_TAG_BLOCK_DEF(s_object_overlays|ccaabb_block)
	TAG_REFL_STRING_ID(label)
	TAG_REFL_PROPERTY(graph_index)
	TAG_REFL_PROPERTY(animation_index)
	TAG_REFL_PROPERTY(unknown)
...
TAG_REFL_TAG_BLOCK_DEF(s_inheritence_list_block)
	TAG_REFL_TAG_REFERENCE(inherited_graph)
TAG_REFL_TAG_BLOCK_DEF(s_node_map_block)
	TAG_REFL_PROPERTY(local_node)
REFL_END
	TAG_REFL_TAG_BLOCK(node_map)
TAG_REFL_TAG_BLOCK_DEF(s_node_map_flags_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_additional_node_data_block)
