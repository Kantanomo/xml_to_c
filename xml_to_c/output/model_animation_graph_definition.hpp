...
TAG_REFL_TAG_BLOCK_DEF(s_model_animation_graph_group_definition::s_animations_group_definition::s_frame_events|abcdcc_block)	TAG_REFL_PROPERTY(type)	TAG_REFL_PROPERTY(frame)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_model_animation_graph_group_definition::s_animations_group_definition::s_sound_events|abcdcc_block)	TAG_REFL_PROPERTY(sound_index)	TAG_REFL_PROPERTY(frame)	TAG_REFL_STRING_ID(marker_name)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_model_animation_graph_group_definition::s_animations_group_definition::s_effect_events|abcdcc_block)	TAG_REFL_PROPERTY(effect_index)	TAG_REFL_PROPERTY(frame)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_model_animation_graph_group_definition::s_animations_group_definition::s_objectspace_parent_nodes|abcdcc_block)	TAG_REFL_PROPERTY(node_index)	TAG_REFL_PROPERTY(component_flags)	TAG_REFL_PROPERTY(rotation_x)	TAG_REFL_PROPERTY(rotation_y)	TAG_REFL_PROPERTY(rotation_z)	TAG_REFL_PROPERTY(rotation_w)	TAG_REFL_PROPERTY(default_translation_x)	TAG_REFL_PROPERTY(default_translation_y)	TAG_REFL_PROPERTY(default_translation_z)	TAG_REFL_PROPERTY(default_scale)REFL_END
...
TAG_REFL_TAG_BLOCK_DEF(s_model_animation_graph_group_definition::s_modes|aabbcc_group_definition::s_weapon_class|aabbcc_group_definition::s_weapon_type|aabbcc_group_definition::s_actions|aabbcc_block)	TAG_REFL_STRING_ID(label)	TAG_REFL_PROPERTY(graph_index)	TAG_REFL_PROPERTY(animation_index)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_model_animation_graph_group_definition::s_modes|aabbcc_group_definition::s_weapon_class|aabbcc_group_definition::s_weapon_type|aabbcc_group_definition::s_overlays|aabbcc_block)	TAG_REFL_STRING_ID(label)	TAG_REFL_PROPERTY(graph_index)	TAG_REFL_PROPERTY(animation_index)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_model_animation_graph_group_definition::s_modes|aabbcc_group_definition::s_weapon_class|aabbcc_group_definition::s_weapon_type|aabbcc_group_definition::s_death_and_damage|aabbcc_group_definition::s_directions_group_definition::s_regions_block)	TAG_REFL_PROPERTY(graph_index)	TAG_REFL_PROPERTY(animation_index)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_model_animation_graph_group_definition::s_modes|aabbcc_group_definition::s_weapon_class|aabbcc_group_definition::s_weapon_type|aabbcc_group_definition::s_death_and_damage|aabbcc_group_definition::s_directions_block)	TAG_REFL_TAG_BLOCK(regions)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_model_animation_graph_group_definition::s_modes|aabbcc_group_definition::s_weapon_class|aabbcc_group_definition::s_weapon_type|aabbcc_group_definition::s_death_and_damage|aabbcc_block)	TAG_REFL_STRING_ID(label)	TAG_REFL_TAG_BLOCK(directions)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_model_animation_graph_group_definition::s_modes|aabbcc_group_definition::s_weapon_class|aabbcc_group_definition::s_weapon_type|aabbcc_group_definition::s_transitions|aabbcc_group_definition::s_destinations|aabbcc_block)	TAG_REFL_STRING_ID(full_name)	TAG_REFL_STRING_ID(mode)	TAG_REFL_STRING_ID(state_name)	TAG_REFL_PROPERTY(frame_event_link)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(index_a)	TAG_REFL_PROPERTY(index_b)	TAG_REFL_PROPERTY(graph_index)	TAG_REFL_PROPERTY(animation_index)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_model_animation_graph_group_definition::s_modes|aabbcc_group_definition::s_weapon_class|aabbcc_group_definition::s_weapon_type|aabbcc_group_definition::s_transitions|aabbcc_block)	TAG_REFL_STRING_ID(full_name)	TAG_REFL_STRING_ID(state_name)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(index_a)	TAG_REFL_PROPERTY(index_b)	TAG_REFL_TAG_BLOCK(destinations|aabbcc)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_model_animation_graph_group_definition::s_modes|aabbcc_group_definition::s_weapon_class|aabbcc_group_definition::s_weapon_type|aabbcc_group_definition::s_high_precache|ccccc_block)	TAG_REFL_PROPERTY(cache_block_index)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_model_animation_graph_group_definition::s_modes|aabbcc_group_definition::s_weapon_class|aabbcc_group_definition::s_weapon_type|aabbcc_group_definition::s_low_precache|ccccc_block)	TAG_REFL_PROPERTY(cache_block_index)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_model_animation_graph_group_definition::s_modes|aabbcc_group_definition::s_weapon_class|aabbcc_group_definition::s_weapon_type|aabbcc_block)	TAG_REFL_STRING_ID(label)	TAG_REFL_TAG_BLOCK(actions|aabbcc)	TAG_REFL_TAG_BLOCK(overlays|aabbcc)	TAG_REFL_TAG_BLOCK(death_and_damage|aabbcc)	TAG_REFL_TAG_BLOCK(transitions|aabbcc)	TAG_REFL_TAG_BLOCK(high_precache|ccccc)	TAG_REFL_TAG_BLOCK(low_precache|ccccc)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_model_animation_graph_group_definition::s_modes|aabbcc_group_definition::s_weapon_class|aabbcc_group_definition::s_weapon_ik|aabbcc_block)	TAG_REFL_STRING_ID(marker)	TAG_REFL_STRING_ID(attach_to_marker)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_model_animation_graph_group_definition::s_modes|aabbcc_group_definition::s_weapon_class|aabbcc_block)	TAG_REFL_STRING_ID(label)	TAG_REFL_TAG_BLOCK(weapon_type|aabbcc)	TAG_REFL_TAG_BLOCK(weapon_ik|aabbcc)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_model_animation_graph_group_definition::s_modes|aabbcc_group_definition::s_mode_ik|aabbcc_block)	TAG_REFL_STRING_ID(marker)	TAG_REFL_STRING_ID(attach_to_marker)REFL_END
...
TAG_REFL_TAG_BLOCK_DEF(s_model_animation_graph_group_definition::s_inheritence_list_group_definition::s_node_map_block)	TAG_REFL_PROPERTY(local_node)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_model_animation_graph_group_definition::s_inheritence_list_group_definition::s_node_map_flags_block)	TAG_REFL_PROPERTY(local_node_flags)REFL_END
