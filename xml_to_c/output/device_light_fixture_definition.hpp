...
TAG_REFL_TAG_BLOCK_DEF(s_device_light_fixture_group_definition::s_ai_properties_block)	TAG_REFL_PROPERTY(flags)	TAG_REFL_STRING_ID(ai_type_name)	TAG_REFL_PROPERTY(size)	TAG_REFL_PROPERTY(leap_jump_speed)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_device_light_fixture_group_definition::s_functions_block)	TAG_REFL_PROPERTY(flags)	TAG_REFL_STRING_ID(import_name)	TAG_REFL_STRING_ID(export_name)	TAG_REFL_STRING_ID(turn_off_with)	TAG_REFL_PROPERTY(minimum_value)	TAG_REFL_DATA_BLOCK(default_function)	TAG_REFL_STRING_ID(scale_by)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_device_light_fixture_group_definition::s_attachments_block)	TAG_REFL_TAG_REFERENCE(type)	TAG_REFL_STRING_ID(marker)	TAG_REFL_PROPERTY(change_color)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_STRING_ID(primary_scale)	TAG_REFL_STRING_ID(secondary_scale)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_device_light_fixture_group_definition::s_widgets_block)	TAG_REFL_TAG_REFERENCE(type)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_device_light_fixture_group_definition::s_old_functions_block)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_device_light_fixture_group_definition::s_change_colors_group_definition::s_initial_permutations_block)	TAG_REFL_PROPERTY(weight)	TAG_REFL_REAL_COLOR_RGB(color_lower_bound)	TAG_REFL_REAL_COLOR_RGB(color_upper_bound)	TAG_REFL_STRING_ID(variant_name)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_device_light_fixture_group_definition::s_change_colors_group_definition::s_functions_block)	TAG_REFL_PROPERTY(scale_flags)	TAG_REFL_REAL_COLOR_RGB(color_lower_bound)	TAG_REFL_REAL_COLOR_RGB(color_upper_bound)	TAG_REFL_STRING_ID(darken_by)	TAG_REFL_STRING_ID(scale_by)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_device_light_fixture_group_definition::s_change_colors_block)	TAG_REFL_TAG_BLOCK(initial_permutations)	TAG_REFL_TAG_BLOCK(functions)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_device_light_fixture_group_definition::s_predicted_resource_block)	TAG_REFL_PROPERTY(type)	TAG_REFL_PROPERTY(resource_index)	TAG_REFL_TAG_REFERENCE(tag_index)REFL_END
