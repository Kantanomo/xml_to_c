...
TAG_REFL_TAG_BLOCK_DEF(s_shader_pass_group_definition::s_postprocess_definitions_block::s_implementations_block::s_pixel_shader_block::s_constant_register_values_block)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_shader_pass_group_definition::s_postprocess_definitions_block::s_implementations_block::s_pixel_shader_block)	TAG_REFL_PROPERTY(pixel_shader_handleruntime)	TAG_REFL_PROPERTY(pixel_shader_handleruntime)	TAG_REFL_PROPERTY(pixel_shader_handleruntime)	TAG_REFL_TAG_BLOCK(constant_register_values)	TAG_REFL_DATA_BLOCK(compiled_shader)	TAG_REFL_DATA_BLOCK(compiled_shader)	TAG_REFL_DATA_BLOCK(compiled_shader)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_shader_pass_group_definition::s_postprocess_definitions_block::s_implementations_block::s_pixel_shader_switch_extern_map_block)	TAG_REFL_PROPERTY(switch_parameter)	TAG_REFL_PROPERTY(case_scalar)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_shader_pass_group_definition::s_postprocess_definitions_block::s_implementations_block::s_pixel_shader_index_block_block)	TAG_REFL_PROPERTY(pixel_shader_index)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_shader_pass_group_definition::s_postprocess_definitions_block::s_implementations_block)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_TAG_REFERENCE(vertex_shader)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_PROPERTY(block_index_data)	TAG_REFL_TAG_BLOCK(pixel_shader)	TAG_REFL_TAG_BLOCK(pixel_shader_switch_extern_map)	TAG_REFL_TAG_BLOCK(pixel_shader_index_block)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_shader_pass_group_definition::s_postprocess_definitions_block::s_textures_block)	TAG_REFL_PROPERTY(bitmap_parameter_index)	TAG_REFL_PROPERTY(bitmap_extern_index)	TAG_REFL_PROPERTY(texture_stage_index)	TAG_REFL_PROPERTY(flags)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_shader_pass_group_definition::s_postprocess_definitions_block::s_render_states_block)	TAG_REFL_PROPERTY(state_index)	TAG_REFL_PROPERTY(state_value)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_shader_pass_group_definition::s_postprocess_definitions_block::s_texture_states_block)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(unknown)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_shader_pass_group_definition::s_postprocess_definitions_block::s_pixel_shader_fragments_block)	TAG_REFL_PROPERTY(switch_parameter_index)	TAG_REFL_PROPERTY(permutation_index)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_shader_pass_group_definition::s_postprocess_definitions_block::s_pixel_shader_permutations_block)	TAG_REFL_PROPERTY(enum_index)	TAG_REFL_PROPERTY(flags)	TAG_REFL_PROPERTY(combiner)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_shader_pass_group_definition::s_postprocess_definitions_block::s_pixel_shader_combiners_block)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(unknown)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_shader_pass_group_definition::s_postprocess_definitions_block::s_externs_block)	TAG_REFL_PROPERTY(extern_index)REFL_END
