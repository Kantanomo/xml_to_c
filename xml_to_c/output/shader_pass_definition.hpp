...
TAG_REFL_TAG_BLOCK_DEF(s_implementations_block)
	...
	TAG_REFL_PROPERTY(block_index_data)
	TAG_REFL_PROPERTY(block_index_data)
TAG_REFL_TAG_BLOCK_DEF(s_pixel_shader_block)
	TAG_REFL_PROPERTY(pixel_shader_handleruntime)
	TAG_REFL_PROPERTY(pixel_shader_handleruntime)
	TAG_REFL_PROPERTY(pixel_shader_handleruntime)
TAG_REFL_TAG_BLOCK_DEF(s_constant_register_values_block)
REFL_END
...
TAG_REFL_TAG_BLOCK_DEF(s_externs_block)
