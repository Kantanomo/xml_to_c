...
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_shader_block)	TAG_REFL_STRING_ID(unknown)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_TAG_REFERENCE(unknown)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(unknown)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_color_block)	TAG_REFL_PROPERTY(data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_alpha_block)	TAG_REFL_PROPERTY(data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_scale_block)	TAG_REFL_PROPERTY(data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_rotation_block)	TAG_REFL_PROPERTY(data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_frame_index_block)	TAG_REFL_PROPERTY(data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_locations_block)	TAG_REFL_STRING_ID(location)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_attached_particle_systems_group_definition::s_emitters_group_definition::s_particle_emission_rate_block)	TAG_REFL_PROPERTY(data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_attached_particle_systems_group_definition::s_emitters_group_definition::s_particle_lifespan_sec_block)	TAG_REFL_PROPERTY(data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_attached_particle_systems_group_definition::s_emitters_group_definition::s_particle_velocity_world_units_per_sec_block)	TAG_REFL_PROPERTY(data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_attached_particle_systems_group_definition::s_emitters_group_definition::s_particle_angular_velocity_degrees_per_sec_block)	TAG_REFL_PROPERTY(data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_attached_particle_systems_group_definition::s_emitters_group_definition::s_particle_size_world_units_block)	TAG_REFL_PROPERTY(data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_attached_particle_systems_group_definition::s_emitters_group_definition::s_particle_tint_block)	TAG_REFL_PROPERTY(data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_attached_particle_systems_group_definition::s_emitters_group_definition::s_particle_alpha_block)	TAG_REFL_PROPERTY(data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_attached_particle_systems_group_definition::s_emitters_group_definition::s_emission_radius_world_units_block)	TAG_REFL_PROPERTY(data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_attached_particle_systems_group_definition::s_emitters_group_definition::s_emission_angle_degrees_block)	TAG_REFL_PROPERTY(data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_attached_particle_systems_group_definition::s_emitters_block)	TAG_REFL_TAG_REFERENCE(particle_physics)	TAG_REFL_PROPERTY(input)	TAG_REFL_PROPERTY(range)	TAG_REFL_PROPERTY(output_modifier)	TAG_REFL_PROPERTY(functions)	TAG_REFL_TAG_BLOCK(particle_emission_rate)	TAG_REFL_PROPERTY(input)	TAG_REFL_PROPERTY(range)	TAG_REFL_PROPERTY(output_modifier)	TAG_REFL_PROPERTY(functions)	TAG_REFL_TAG_BLOCK(particle_lifespan_sec)	TAG_REFL_PROPERTY(input)	TAG_REFL_PROPERTY(range)	TAG_REFL_PROPERTY(output_modifier)	TAG_REFL_PROPERTY(functions)	TAG_REFL_TAG_BLOCK(particle_velocity_world_units_per_sec)	TAG_REFL_PROPERTY(input)	TAG_REFL_PROPERTY(range)	TAG_REFL_PROPERTY(output_modifier)	TAG_REFL_PROPERTY(functions)	TAG_REFL_TAG_BLOCK(particle_angular_velocity_degrees_per_sec)	TAG_REFL_PROPERTY(input)	TAG_REFL_PROPERTY(range)	TAG_REFL_PROPERTY(output_modifier)	TAG_REFL_PROPERTY(functions)	TAG_REFL_TAG_BLOCK(particle_size_world_units)	TAG_REFL_PROPERTY(input)	TAG_REFL_PROPERTY(range)	TAG_REFL_PROPERTY(output_modifier)	TAG_REFL_PROPERTY(functions)	TAG_REFL_TAG_BLOCK(particle_tint)	TAG_REFL_PROPERTY(input)	TAG_REFL_PROPERTY(range)	TAG_REFL_PROPERTY(output_modifier)	TAG_REFL_PROPERTY(functions)	TAG_REFL_TAG_BLOCK(particle_alpha)	TAG_REFL_PROPERTY(emission_shape)	TAG_REFL_PROPERTY(input)	TAG_REFL_PROPERTY(range)	TAG_REFL_PROPERTY(output_modifier)	TAG_REFL_PROPERTY(functions)	TAG_REFL_TAG_BLOCK(emission_radius_world_units)	TAG_REFL_PROPERTY(input)	TAG_REFL_PROPERTY(range)	TAG_REFL_PROPERTY(output_modifier)	TAG_REFL_PROPERTY(functions)	TAG_REFL_TAG_BLOCK(emission_angle_degrees)	TAG_REFL_PROPERTY(translation_offset_x)	TAG_REFL_PROPERTY(translation_offset_y)	TAG_REFL_PROPERTY(translation_offset_z)	TAG_REFL_ANGLE(relative_direction_yaw)	TAG_REFL_ANGLE(relative_direction_pitch)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_attached_particle_systems_block)	TAG_REFL_TAG_REFERENCE(particle)	TAG_REFL_PROPERTY(location)	TAG_REFL_PROPERTY(coordinate_system)	TAG_REFL_PROPERTY(environment)	TAG_REFL_PROPERTY(disposition)	TAG_REFL_PROPERTY(camera_mode)	TAG_REFL_PROPERTY(sort_bias)	TAG_REFL_PROPERTY(flags)	TAG_REFL_PROPERTY(lod_in_distance)	TAG_REFL_PROPERTY(lod_feather_in_delta)	TAG_REFL_PROPERTY(lod_out_distance)	TAG_REFL_PROPERTY(lod_feather_out_delta)	TAG_REFL_TAG_BLOCK(emitters)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_postprocess_definitions_group_definition::s_bitmaps_block)	TAG_REFL_TAG_REFERENCE(bitmapgroup)	TAG_REFL_PROPERTY(bitmapindex)	TAG_REFL_PROPERTY(logbitmapdimension)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_postprocess_definitions_group_definition::s_pixel_constants_block)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_postprocess_definitions_group_definition::s_vertex_constants_block)	TAG_REFL_PROPERTY(xscale)	TAG_REFL_PROPERTY(yscale)	TAG_REFL_PROPERTY(zscale)	TAG_REFL_PROPERTY(wscale)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_postprocess_definitions_group_definition::s_levels_of_detail_block)	TAG_REFL_PROPERTY(availablelayerflags)	TAG_REFL_PROPERTY(layers)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_postprocess_definitions_group_definition::s_layers_block)	TAG_REFL_PROPERTY(indice)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_postprocess_definitions_group_definition::s_passes_block)	TAG_REFL_PROPERTY(indice)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_postprocess_definitions_group_definition::s_implementations_block)	TAG_REFL_PROPERTY(bitmaptransform)	TAG_REFL_PROPERTY(renderstate)	TAG_REFL_PROPERTY(texturestate)	TAG_REFL_PROPERTY(pixelconstant)	TAG_REFL_PROPERTY(vertexconstant)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_postprocess_definitions_group_definition::s_overlays_group_definition::s_functions_block)	TAG_REFL_PROPERTY(function)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_postprocess_definitions_group_definition::s_overlays_block)	TAG_REFL_STRING_ID(inputname)	TAG_REFL_STRING_ID(rangename)	TAG_REFL_PROPERTY(timeperiodinseconds)	TAG_REFL_TAG_BLOCK(functions)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_postprocess_definitions_group_definition::s_overlay_references_block)	TAG_REFL_PROPERTY(overlayindex)	TAG_REFL_PROPERTY(transformindex)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_postprocess_definitions_group_definition::s_animated_parameters_block)	TAG_REFL_PROPERTY(overlayreference)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_postprocess_definitions_group_definition::s_animated_parameter_references_block)	TAG_REFL_PROPERTY(parameterindex)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_postprocess_definitions_group_definition::s_bitmap_properties_block)	TAG_REFL_PROPERTY(bitmapindex)	TAG_REFL_PROPERTY(animatedparameterindex)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_postprocess_definitions_group_definition::s_color_properties_block)	TAG_REFL_REAL_COLOR_RGB(colour)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_postprocess_definitions_group_definition::s_value_properties_block)	TAG_REFL_PROPERTY(value)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_postprocess_definitions_block)	TAG_REFL_TAG_REFERENCE(shadertemplate)	TAG_REFL_TAG_BLOCK(bitmaps)	TAG_REFL_TAG_BLOCK(pixel_constants)	TAG_REFL_TAG_BLOCK(vertex_constants)	TAG_REFL_TAG_BLOCK(levels_of_detail)	TAG_REFL_TAG_BLOCK(layers)	TAG_REFL_TAG_BLOCK(passes)	TAG_REFL_TAG_BLOCK(implementations)	TAG_REFL_TAG_BLOCK(overlays)	TAG_REFL_TAG_BLOCK(overlay_references)	TAG_REFL_TAG_BLOCK(animated_parameters)	TAG_REFL_TAG_BLOCK(animated_parameter_references)	TAG_REFL_TAG_BLOCK(bitmap_properties)	TAG_REFL_TAG_BLOCK(color_properties)	TAG_REFL_TAG_BLOCK(value_properties)REFL_END
