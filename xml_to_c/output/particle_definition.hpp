...
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_attached_particle_systems_block::s_emitters_block::s_particle_emission_rate_block)	TAG_REFL_PROPERTY(data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_attached_particle_systems_block::s_emitters_block::s_particle_lifespan_sec_block)	TAG_REFL_PROPERTY(data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_attached_particle_systems_block::s_emitters_block::s_particle_velocity_world_units_per_sec_block)	TAG_REFL_PROPERTY(data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_attached_particle_systems_block::s_emitters_block::s_particle_angular_velocity_degrees_per_sec_block)	TAG_REFL_PROPERTY(data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_attached_particle_systems_block::s_emitters_block::s_particle_size_world_units_block)	TAG_REFL_PROPERTY(data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_attached_particle_systems_block::s_emitters_block::s_particle_tint_block)	TAG_REFL_PROPERTY(data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_attached_particle_systems_block::s_emitters_block::s_particle_alpha_block)	TAG_REFL_PROPERTY(data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_attached_particle_systems_block::s_emitters_block::s_emission_radius_world_units_block)	TAG_REFL_PROPERTY(data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_attached_particle_systems_block::s_emitters_block::s_emission_angle_degrees_block)	TAG_REFL_PROPERTY(data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_attached_particle_systems_block::s_emitters_block)	TAG_REFL_TAG_REFERENCE(particle_physics)	TAG_REFL_PROPERTY(input)	TAG_REFL_PROPERTY(range)	TAG_REFL_PROPERTY(output_modifier)	TAG_REFL_PROPERTY(functions)	TAG_REFL_TAG_BLOCK(particle_emission_rate)	TAG_REFL_PROPERTY(input)	TAG_REFL_PROPERTY(range)	TAG_REFL_PROPERTY(output_modifier)	TAG_REFL_PROPERTY(functions)	TAG_REFL_TAG_BLOCK(particle_lifespan_sec)	TAG_REFL_PROPERTY(input)	TAG_REFL_PROPERTY(range)	TAG_REFL_PROPERTY(output_modifier)	TAG_REFL_PROPERTY(functions)	TAG_REFL_TAG_BLOCK(particle_velocity_world_units_per_sec)	TAG_REFL_PROPERTY(input)	TAG_REFL_PROPERTY(range)	TAG_REFL_PROPERTY(output_modifier)	TAG_REFL_PROPERTY(functions)	TAG_REFL_TAG_BLOCK(particle_angular_velocity_degrees_per_sec)	TAG_REFL_PROPERTY(input)	TAG_REFL_PROPERTY(range)	TAG_REFL_PROPERTY(output_modifier)	TAG_REFL_PROPERTY(functions)	TAG_REFL_TAG_BLOCK(particle_size_world_units)	TAG_REFL_PROPERTY(input)	TAG_REFL_PROPERTY(range)	TAG_REFL_PROPERTY(output_modifier)	TAG_REFL_PROPERTY(functions)	TAG_REFL_TAG_BLOCK(particle_tint)	TAG_REFL_PROPERTY(input)	TAG_REFL_PROPERTY(range)	TAG_REFL_PROPERTY(output_modifier)	TAG_REFL_PROPERTY(functions)	TAG_REFL_TAG_BLOCK(particle_alpha)	TAG_REFL_PROPERTY(emission_shape)	TAG_REFL_PROPERTY(input)	TAG_REFL_PROPERTY(range)	TAG_REFL_PROPERTY(output_modifier)	TAG_REFL_PROPERTY(functions)	TAG_REFL_TAG_BLOCK(emission_radius_world_units)	TAG_REFL_PROPERTY(input)	TAG_REFL_PROPERTY(range)	TAG_REFL_PROPERTY(output_modifier)	TAG_REFL_PROPERTY(functions)	TAG_REFL_TAG_BLOCK(emission_angle_degrees)	TAG_REFL_PROPERTY(translation_offset_x)	TAG_REFL_PROPERTY(translation_offset_y)	TAG_REFL_PROPERTY(translation_offset_z)	TAG_REFL_ANGLE(relative_direction_yaw)	TAG_REFL_ANGLE(relative_direction_pitch)REFL_END
...
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_postprocess_definitions_block::s_bitmaps_block)	TAG_REFL_TAG_REFERENCE(bitmapgroup)	TAG_REFL_PROPERTY(bitmapindex)	TAG_REFL_PROPERTY(logbitmapdimension)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_postprocess_definitions_block::s_pixel_constants_block)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_postprocess_definitions_block::s_vertex_constants_block)	TAG_REFL_PROPERTY(xscale)	TAG_REFL_PROPERTY(yscale)	TAG_REFL_PROPERTY(zscale)	TAG_REFL_PROPERTY(wscale)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_postprocess_definitions_block::s_levels_of_detail_block)	TAG_REFL_PROPERTY(availablelayerflags)	TAG_REFL_PROPERTY(layers)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_postprocess_definitions_block::s_layers_block)	TAG_REFL_PROPERTY(indice)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_postprocess_definitions_block::s_passes_block)	TAG_REFL_PROPERTY(indice)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_postprocess_definitions_block::s_implementations_block)	TAG_REFL_PROPERTY(bitmaptransform)	TAG_REFL_PROPERTY(renderstate)	TAG_REFL_PROPERTY(texturestate)	TAG_REFL_PROPERTY(pixelconstant)	TAG_REFL_PROPERTY(vertexconstant)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_postprocess_definitions_block::s_overlays_block::s_functions_block)	TAG_REFL_PROPERTY(function)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_postprocess_definitions_block::s_overlays_block)	TAG_REFL_STRING_ID(inputname)	TAG_REFL_STRING_ID(rangename)	TAG_REFL_PROPERTY(timeperiodinseconds)	TAG_REFL_TAG_BLOCK(functions)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_postprocess_definitions_block::s_overlay_references_block)	TAG_REFL_PROPERTY(overlayindex)	TAG_REFL_PROPERTY(transformindex)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_postprocess_definitions_block::s_animated_parameters_block)	TAG_REFL_PROPERTY(overlayreference)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_postprocess_definitions_block::s_animated_parameter_references_block)	TAG_REFL_PROPERTY(parameterindex)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_postprocess_definitions_block::s_bitmap_properties_block)	TAG_REFL_PROPERTY(bitmapindex)	TAG_REFL_PROPERTY(animatedparameterindex)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_postprocess_definitions_block::s_color_properties_block)	TAG_REFL_REAL_COLOR_RGB(colour)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_particle_group_definition::s_postprocess_definitions_block::s_value_properties_block)	TAG_REFL_PROPERTY(value)REFL_END
