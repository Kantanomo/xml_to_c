...
TAG_REFL_TAG_BLOCK_DEF(s_variation_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_placement_properties_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_perception_properties_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_look_properties_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_movement_properties_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_swarm_properties_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_ready_properties_block)
	TAG_REFL_PROPERTY(ready_time_bounds)
	TAG_REFL_PROPERTY(to)
REFL_END
	TAG_REFL_TAG_BLOCK(ready_properties)
TAG_REFL_TAG_BLOCK_DEF(s_engage_properties_block)
	TAG_REFL_PROPERTY(flags)
...
TAG_REFL_TAG_BLOCK_DEF(s_charge_properties_block)
	TAG_REFL_PROPERTY(flags)
...
TAG_REFL_TAG_BLOCK_DEF(s_evasion_properties_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_cover_properties_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_retreat_properties_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_search_properties_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_presearch_properties_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_firing_pattern_properties_block)
	TAG_REFL_TAG_REFERENCE(weapon)
TAG_REFL_TAG_BLOCK_DEF(s_firing_patterns_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_grenades_properties_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_vehicle_properties_block)
