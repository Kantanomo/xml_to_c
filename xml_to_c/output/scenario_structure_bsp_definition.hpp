...
TAG_REFL_TAG_BLOCK_DEF(s_unk_block)
REFL_END
	TAG_REFL_TAG_BLOCK(unk)
	TAG_REFL_PROPERTY(bsp_checksum)
TAG_REFL_TAG_BLOCK_DEF(s_collision_materials_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_collision_bsp_block)
TAG_REFL_TAG_BLOCK_DEF(s_NUM_3d_nodes_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_planes_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_surfaces_block)
	TAG_REFL_PROPERTY(plane)
...
TAG_REFL_TAG_BLOCK_DEF(s_edges_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_cluster_portals_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_fog_planes_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_weather_polyhedra_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_detail_objects_block)
TAG_REFL_TAG_BLOCK_DEF(s_cells_block)
	TAG_REFL_PROPERTY(unknown)
	TAG_REFL_PROPERTY(unknown)
	TAG_REFL_PROPERTY(unknown)
	TAG_REFL_PROPERTY(unknown)
...
TAG_REFL_TAG_BLOCK_DEF(s_instances_block)
	TAG_REFL_PROPERTY(unknown)
	TAG_REFL_PROPERTY(unknown)
	TAG_REFL_PROPERTY(unknown)
	TAG_REFL_PROPERTY(unknown)
...
TAG_REFL_TAG_BLOCK_DEF(s_counts_block)
	TAG_REFL_PROPERTY(unknown)
REFL_END
	TAG_REFL_TAG_BLOCK(counts)
TAG_REFL_TAG_BLOCK_DEF(s_z_reference_vectors_block)
	TAG_REFL_PROPERTY(unknown)
	TAG_REFL_PROPERTY(unknown)
	TAG_REFL_PROPERTY(unknown)
	TAG_REFL_PROPERTY(unknown)
...
REFL_END
	...
	TAG_REFL_PROPERTY(unknown)
TAG_REFL_TAG_BLOCK_DEF(s_cluster_data_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_subparts_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_visibility_bounds_block)
	TAG_REFL_PROPERTY(position_x)
	TAG_REFL_PROPERTY(position_y)
	TAG_REFL_PROPERTY(position_z)
...
TAG_REFL_TAG_BLOCK_DEF(s_raw_vertices_block)
	TAG_REFL_PROPERTY(position_x)
	TAG_REFL_PROPERTY(position_y)
	TAG_REFL_PROPERTY(position_z)
...
TAG_REFL_TAG_BLOCK_DEF(s_mopp_reorder_table_block)
	TAG_REFL_PROPERTY(index)
REFL_END
	TAG_REFL_TAG_BLOCK(mopp_reorder_table)
TAG_REFL_TAG_BLOCK_DEF(s_vertex_buffers_block)
REFL_END
...
TAG_REFL_TAG_BLOCK_DEF(s_sky_owner_cluster_block)
	TAG_REFL_PROPERTY(cluster_owner)
REFL_END
	TAG_REFL_TAG_BLOCK(sky_owner_cluster)
TAG_REFL_TAG_BLOCK_DEF(s_conveyor_surfaces_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_breakable_surfaces_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_pathfinding_data_block)
TAG_REFL_TAG_BLOCK_DEF(s_sectors_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_refs_block)
...
REFL_END
	TAG_REFL_TAG_BLOCK(bsp_2d_nodes)
TAG_REFL_TAG_BLOCK_DEF(s_surface_flags_block)
	TAG_REFL_PROPERTY(flags)
REFL_END
...
REFL_END
	TAG_REFL_TAG_BLOCK(vertices)
TAG_REFL_TAG_BLOCK_DEF(s_object_refs_block)
	TAG_REFL_PROPERTY(flags)
	TAG_REFL_PROPERTY(unknown)
	TAG_REFL_PROPERTY(first_sector)
	TAG_REFL_PROPERTY(last_sector)
TAG_REFL_TAG_BLOCK_DEF(s_bsps_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_pathfinding_hints_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_instanced_geometry_refs_block)
	TAG_REFL_PROPERTY(pathfinding_object_index)
	TAG_REFL_PROPERTY(unknown)
REFL_END
	TAG_REFL_TAG_BLOCK(instanced_geometry_refs)
	TAG_REFL_PROPERTY(structure_checksum)
TAG_REFL_TAG_BLOCK_DEF(s_user_placed_hints_block)
TAG_REFL_TAG_BLOCK_DEF(s_point_geometry_block)
	TAG_REFL_PROPERTY(point_x)
	TAG_REFL_PROPERTY(point_y)
	TAG_REFL_PROPERTY(point_z)
...
TAG_REFL_TAG_BLOCK_DEF(s_ray_geometry_block)
	TAG_REFL_PROPERTY(point_x)
	TAG_REFL_PROPERTY(point_y)
	TAG_REFL_PROPERTY(point_z)
	TAG_REFL_PROPERTY(reference_frame)
...
TAG_REFL_TAG_BLOCK_DEF(s_line_segment_geometry_block)
	TAG_REFL_PROPERTY(flags)
...
TAG_REFL_TAG_BLOCK_DEF(s_parallelogram_geometry_block)
	TAG_REFL_PROPERTY(flags)
	TAG_REFL_PROPERTY(point_0_x)
	TAG_REFL_PROPERTY(point_0_y)
	TAG_REFL_PROPERTY(point_0_z)
...
TAG_REFL_TAG_BLOCK_DEF(s_polygon_geometry_block)
	TAG_REFL_PROPERTY(flags)
...
TAG_REFL_TAG_BLOCK_DEF(s_jump_hints_block)
	TAG_REFL_PROPERTY(flags)
...
TAG_REFL_TAG_BLOCK_DEF(s_climb_hints_block)
	TAG_REFL_PROPERTY(flags)
	TAG_REFL_PROPERTY(geometry_index)
REFL_END
	TAG_REFL_TAG_BLOCK(climb_hints)
TAG_REFL_TAG_BLOCK_DEF(s_well_hints_block)
	TAG_REFL_PROPERTY(flags)
TAG_REFL_TAG_BLOCK_DEF(s_points_block)
	TAG_REFL_PROPERTY(type)
	TAG_REFL_PROPERTY(unknown)
...
TAG_REFL_TAG_BLOCK_DEF(s_pathfinding_edges_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_runtime_decals_block)
	TAG_REFL_PROPERTY(unknown)
	TAG_REFL_PROPERTY(unknown)
	TAG_REFL_PROPERTY(unknown)
REFL_END
	TAG_REFL_TAG_BLOCK(runtime_decals)
TAG_REFL_TAG_BLOCK_DEF(s_environment_object_palette_block)
	TAG_REFL_TAG_REFERENCE(definition)
	TAG_REFL_TAG_REFERENCE(model)
	TAG_REFL_PROPERTY(object_type)
REFL_END
	TAG_REFL_TAG_BLOCK(environment_object_palette)
TAG_REFL_TAG_BLOCK_DEF(s_environment_objects_block)
	TAG_REFL_STRING_32(name)
	TAG_REFL_PROPERTY(rotation_i)
	TAG_REFL_PROPERTY(rotation_j)
	TAG_REFL_PROPERTY(rotation_k)
...
TAG_REFL_TAG_BLOCK_DEF(s_instanced_geometry_definitions_block)
	TAG_REFL_PROPERTY(total_vertex_count)
	TAG_REFL_PROPERTY(total_triangle_count)
	TAG_REFL_PROPERTY(total_part_count)
	TAG_REFL_PROPERTY(shadowcasting_triangle_count)
...
REFL_END
	...
	TAG_REFL_PROPERTY(owner_tag_section_offset)
	TAG_REFL_PROPERTY(unknown)
TAG_REFL_TAG_BLOCK_DEF(s_render_data_block)
TAG_REFL_TAG_BLOCK_DEF(s_parts_block)
	TAG_REFL_PROPERTY(type)
	TAG_REFL_PROPERTY(flags)
	TAG_REFL_PROPERTY(material_index)
...
REFL_END
	...
	TAG_REFL_PROPERTY(bounding_sphere_radius)
TAG_REFL_TAG_BLOCK_DEF(s_bsp_3d_nodes_block)
REFL_END
...
REFL_END
	TAG_REFL_TAG_BLOCK(vertices)
TAG_REFL_TAG_BLOCK_DEF(s_bsp_physics_block)
	...
	TAG_REFL_PROPERTY(size)
	TAG_REFL_PROPERTY(count)
TAG_REFL_TAG_BLOCK_DEF(s_mopp_code_data_block)
	TAG_REFL_PROPERTY(data)
REFL_END
	TAG_REFL_TAG_BLOCK(mopp_code_data)
REFL_END
	TAG_REFL_TAG_BLOCK(bsp_physics)
TAG_REFL_TAG_BLOCK_DEF(s_render_leaves_block)
	TAG_REFL_PROPERTY(cluster)
	TAG_REFL_PROPERTY(surface_reference_count)
...
TAG_REFL_TAG_BLOCK_DEF(s_instanced_geometry_instances_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_ambience_sound_clusters_block)
	TAG_REFL_PROPERTY(unknown)
	TAG_REFL_PROPERTY(unknown)
TAG_REFL_TAG_BLOCK_DEF(s_enclosing_portal_designators_block)
	TAG_REFL_PROPERTY(portal_designator)
REFL_END
	TAG_REFL_TAG_BLOCK(enclosing_portal_designators)
TAG_REFL_TAG_BLOCK_DEF(s_interior_cluster_indices_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_reverb_sound_clusters_block)
	TAG_REFL_PROPERTY(unknown)
	TAG_REFL_PROPERTY(unknown)
TAG_REFL_TAG_BLOCK_DEF(s_enclosing_portal_designators_block)
	TAG_REFL_PROPERTY(portal_designator)
...
TAG_REFL_TAG_BLOCK_DEF(s_transparent_planes_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_debug_info_block)
TAG_REFL_TAG_BLOCK_DEF(s_clusters_block)
	TAG_REFL_PROPERTY(errors)
	TAG_REFL_PROPERTY(warnings)
TAG_REFL_TAG_BLOCK_DEF(s_lines_block)
	TAG_REFL_PROPERTY(type)
...
TAG_REFL_TAG_BLOCK_DEF(s_fog_plane_indices_block)
	TAG_REFL_PROPERTY(index)
REFL_END
	TAG_REFL_TAG_BLOCK(fog_plane_indices)
TAG_REFL_TAG_BLOCK_DEF(s_visible_fog_plane_indices_block)
	TAG_REFL_PROPERTY(index)
REFL_END
	TAG_REFL_TAG_BLOCK(visible_fog_plane_indices)
TAG_REFL_TAG_BLOCK_DEF(s_visible_fog_omission_cluster_indices_block)
	TAG_REFL_PROPERTY(index)
REFL_END
	TAG_REFL_TAG_BLOCK(visible_fog_omission_cluster_indices)
TAG_REFL_TAG_BLOCK_DEF(s_containing_fog_zone_indices_block)
	TAG_REFL_PROPERTY(index)
REFL_END
...
REFL_END
	TAG_REFL_TAG_BLOCK(lines)
TAG_REFL_TAG_BLOCK_DEF(s_intersected_cluster_indices_block)
	TAG_REFL_PROPERTY(index)
REFL_END
	TAG_REFL_TAG_BLOCK(intersected_cluster_indices)
TAG_REFL_TAG_BLOCK_DEF(s_infinite_extent_cluster_indices_block)
	TAG_REFL_PROPERTY(index)
REFL_END
	TAG_REFL_TAG_BLOCK(infinite_extent_cluster_indices)
REFL_END
	TAG_REFL_TAG_BLOCK(fog_planes)
TAG_REFL_TAG_BLOCK_DEF(s_fog_zones_block)
...
REFL_END
	TAG_REFL_TAG_BLOCK(lines)
TAG_REFL_TAG_BLOCK_DEF(s_immersed_cluster_indices_block)
	TAG_REFL_PROPERTY(index)
REFL_END
	TAG_REFL_TAG_BLOCK(immersed_cluster_indices)
TAG_REFL_TAG_BLOCK_DEF(s_bounding_fog_plane_indices_block)
	TAG_REFL_PROPERTY(index)
REFL_END
	TAG_REFL_TAG_BLOCK(bounding_fog_plane_indices)
TAG_REFL_TAG_BLOCK_DEF(s_collision_fog_plane_indices_block)
	TAG_REFL_PROPERTY(index)
REFL_END
...
TAG_REFL_TAG_BLOCK_DEF(s_breakable_surface_key_table_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_water_definitions_block)
	TAG_REFL_TAG_REFERENCE(shader)
TAG_REFL_TAG_BLOCK_DEF(s_section_block)
TAG_REFL_TAG_BLOCK_DEF(s_parts_block)
	TAG_REFL_PROPERTY(type)
	TAG_REFL_PROPERTY(flags)
	TAG_REFL_PROPERTY(material_index)
...
TAG_REFL_TAG_BLOCK_DEF(s_portal_device_mapping_block)
TAG_REFL_TAG_BLOCK_DEF(s_device_portal_association_block)
	TAG_REFL_PROPERTY(unique_id)
...
TAG_REFL_TAG_BLOCK_DEF(s_game_portal_to_portal_map_block)
	TAG_REFL_PROPERTY(portal_index)
REFL_END
	TAG_REFL_TAG_BLOCK(game_portal_to_portal_map)
REFL_END
	TAG_REFL_TAG_BLOCK(portal_device_mapping)
TAG_REFL_TAG_BLOCK_DEF(s_audibility_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_encoded_door_pas_block)
	TAG_REFL_PROPERTY(unknown)
REFL_END
	TAG_REFL_TAG_BLOCK(encoded_door_pas)
TAG_REFL_TAG_BLOCK_DEF(s_cluster_door_portal_encoded_pas_block)
	TAG_REFL_PROPERTY(unknown)
REFL_END
	TAG_REFL_TAG_BLOCK(cluster_door_portal_encoded_pas)
TAG_REFL_TAG_BLOCK_DEF(s_ai_deafening_pas_block)
	TAG_REFL_PROPERTY(unknown)
REFL_END
	TAG_REFL_TAG_BLOCK(ai_deafening_pas)
TAG_REFL_TAG_BLOCK_DEF(s_cluster_distances_block)
	TAG_REFL_PROPERTY(unknown)
REFL_END
	TAG_REFL_TAG_BLOCK(cluster_distances)
TAG_REFL_TAG_BLOCK_DEF(s_machine_door_mapping_block)
	TAG_REFL_PROPERTY(machine_door_index)
REFL_END
	TAG_REFL_TAG_BLOCK(machine_door_mapping)
REFL_END
	TAG_REFL_TAG_BLOCK(audibility)
TAG_REFL_TAG_BLOCK_DEF(s_object_fake_lightprobes_block)
	TAG_REFL_PROPERTY(unique_id)
	TAG_REFL_PROPERTY(origin_bsp_index)
	TAG_REFL_PROPERTY(type)
	TAG_REFL_PROPERTY(source)
...
TAG_REFL_TAG_BLOCK_DEF(s_decorators_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_cache_blocks_block)
	TAG_REFL_PROPERTY(block_offset)
	TAG_REFL_PROPERTY(block_size)
	TAG_REFL_PROPERTY(section_data_size)
	TAG_REFL_PROPERTY(resource_data_size)
...
REFL_END
	...
	TAG_REFL_PROPERTY(owner_tag_section_offset)
	TAG_REFL_PROPERTY(unknown)
TAG_REFL_TAG_BLOCK_DEF(s_cache_block_data_block)
TAG_REFL_TAG_BLOCK_DEF(s_placements_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_decal_vertices_block)
	TAG_REFL_PROPERTY(position_x)
	TAG_REFL_PROPERTY(position_y)
	TAG_REFL_PROPERTY(position_z)
...
TAG_REFL_TAG_BLOCK_DEF(s_decal_indices_block)
	TAG_REFL_PROPERTY(index)
REFL_END
	TAG_REFL_TAG_BLOCK(decal_indices)
TAG_REFL_TAG_BLOCK_DEF(s_sprite_vertices_block)
	TAG_REFL_PROPERTY(position_x)
	TAG_REFL_PROPERTY(position_y)
	TAG_REFL_PROPERTY(position_z)
...
TAG_REFL_TAG_BLOCK_DEF(s_sprite_indices_block)
	TAG_REFL_PROPERTY(index)
REFL_END
...
TAG_REFL_TAG_BLOCK_DEF(s_groups_block)
