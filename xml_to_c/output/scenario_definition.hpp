...
TAG_REFL_TAG_BLOCK_DEF(s_skies_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_comments_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_object_names_block)
	TAG_REFL_STRING_32(name)
	TAG_REFL_PROPERTY(type)
	TAG_REFL_PROPERTY(placement_index)
REFL_END
	TAG_REFL_TAG_BLOCK(object_names)
TAG_REFL_TAG_BLOCK_DEF(s_scenery_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_pathfinding_references_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_scenery_palette_block)
	TAG_REFL_TAG_REFERENCE(scenery)
REFL_END
	TAG_REFL_TAG_BLOCK(scenery_palette)
TAG_REFL_TAG_BLOCK_DEF(s_bipeds_block)
	TAG_REFL_PROPERTY(palette_index)
	TAG_REFL_PROPERTY(name_index)
	TAG_REFL_PROPERTY(placement_flags)
	TAG_REFL_PROPERTY(position_x)
...
TAG_REFL_TAG_BLOCK_DEF(s_biped_palette_block)
	TAG_REFL_TAG_REFERENCE(biped)
REFL_END
	TAG_REFL_TAG_BLOCK(biped_palette)
TAG_REFL_TAG_BLOCK_DEF(s_vehicles_block)
	TAG_REFL_PROPERTY(palette_index)
	TAG_REFL_PROPERTY(name_index)
	TAG_REFL_PROPERTY(placement_flags)
	TAG_REFL_PROPERTY(position_x)
...
TAG_REFL_TAG_BLOCK_DEF(s_vehicle_palette_block)
	TAG_REFL_TAG_REFERENCE(vehicle)
REFL_END
	TAG_REFL_TAG_BLOCK(vehicle_palette)
TAG_REFL_TAG_BLOCK_DEF(s_equipment_block)
	TAG_REFL_PROPERTY(palette_index)
	TAG_REFL_PROPERTY(name_index)
	TAG_REFL_PROPERTY(placement_flags)
	TAG_REFL_PROPERTY(position_x)
...
TAG_REFL_TAG_BLOCK_DEF(s_equipment_palette_block)
	TAG_REFL_TAG_REFERENCE(equipment)
REFL_END
	TAG_REFL_TAG_BLOCK(equipment_palette)
TAG_REFL_TAG_BLOCK_DEF(s_weapons_block)
	TAG_REFL_PROPERTY(palette_index)
	TAG_REFL_PROPERTY(name_index)
	TAG_REFL_PROPERTY(placement_flags)
	TAG_REFL_PROPERTY(position_x)
...
TAG_REFL_TAG_BLOCK_DEF(s_weapon_palette_block)
	TAG_REFL_TAG_REFERENCE(weapon)
REFL_END
	TAG_REFL_TAG_BLOCK(weapon_palette)
TAG_REFL_TAG_BLOCK_DEF(s_device_groups_block)
	TAG_REFL_STRING_32(name)
	TAG_REFL_PROPERTY(inital_value)
	TAG_REFL_PROPERTY(flags)
REFL_END
	TAG_REFL_TAG_BLOCK(device_groups)
TAG_REFL_TAG_BLOCK_DEF(s_machines_block)
	TAG_REFL_PROPERTY(palette_index)
	TAG_REFL_PROPERTY(name_index)
	TAG_REFL_PROPERTY(placement_flags)
	TAG_REFL_PROPERTY(position_x)
...
TAG_REFL_TAG_BLOCK_DEF(s_machine_palette_block)
	TAG_REFL_TAG_REFERENCE(machine)
REFL_END
	TAG_REFL_TAG_BLOCK(machine_palette)
TAG_REFL_TAG_BLOCK_DEF(s_controls_block)
	TAG_REFL_PROPERTY(palette_index)
	TAG_REFL_PROPERTY(name_index)
	TAG_REFL_PROPERTY(placement_flags)
	TAG_REFL_PROPERTY(position_x)
...
TAG_REFL_TAG_BLOCK_DEF(s_control_palette_block)
	TAG_REFL_TAG_REFERENCE(control)
REFL_END
	TAG_REFL_TAG_BLOCK(control_palette)
TAG_REFL_TAG_BLOCK_DEF(s_light_fixtures_block)
	TAG_REFL_PROPERTY(palette_index)
	TAG_REFL_PROPERTY(name_index)
	TAG_REFL_PROPERTY(placement_flags)
	TAG_REFL_PROPERTY(position_x)
...
TAG_REFL_TAG_BLOCK_DEF(s_light_fixtures_palette_block)
	TAG_REFL_TAG_REFERENCE(light_fixture)
REFL_END
	TAG_REFL_TAG_BLOCK(light_fixtures_palette)
TAG_REFL_TAG_BLOCK_DEF(s_sound_scenery_block)
	TAG_REFL_PROPERTY(palette_index)
	TAG_REFL_PROPERTY(name_index)
	TAG_REFL_PROPERTY(placement_flags)
	TAG_REFL_PROPERTY(position_x)
...
TAG_REFL_TAG_BLOCK_DEF(s_sound_scenery_palette_block)
	TAG_REFL_TAG_REFERENCE(sound_scenery)
REFL_END
	TAG_REFL_TAG_BLOCK(sound_scenery_palette)
TAG_REFL_TAG_BLOCK_DEF(s_light_volumes_block)
	TAG_REFL_PROPERTY(palette_index)
	TAG_REFL_PROPERTY(name_index)
	TAG_REFL_PROPERTY(placement_flags)
	TAG_REFL_PROPERTY(position_x)
...
TAG_REFL_TAG_BLOCK_DEF(s_light_volumes_palette_block)
	TAG_REFL_TAG_REFERENCE(light_volume)
REFL_END
	TAG_REFL_TAG_BLOCK(light_volumes_palette)
TAG_REFL_TAG_BLOCK_DEF(s_player_starting_profile_block)
	TAG_REFL_STRING_32(name)
...
TAG_REFL_TAG_BLOCK_DEF(s_player_starting_locations_block)
	TAG_REFL_PROPERTY(position_x)
	TAG_REFL_PROPERTY(position_y)
	TAG_REFL_PROPERTY(position_z)
...
TAG_REFL_TAG_BLOCK_DEF(s_trigger_volumes_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_netgame_flags_block)
	TAG_REFL_PROPERTY(position_x)
	TAG_REFL_PROPERTY(position_y)
	TAG_REFL_PROPERTY(position_z)
	TAG_REFL_ANGLE(facing)
...
TAG_REFL_TAG_BLOCK_DEF(s_netgame_equipment_block)
	TAG_REFL_PROPERTY(flags)
	TAG_REFL_PROPERTY(game_type_1)
	TAG_REFL_PROPERTY(game_type_2)
	TAG_REFL_PROPERTY(game_type_3)
...
TAG_REFL_TAG_BLOCK_DEF(s_starting_equipment_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_bsp_switch_trigger_volumes_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_decals_block)
	TAG_REFL_PROPERTY(palette_index)
...
TAG_REFL_TAG_BLOCK_DEF(s_starting_loctations_block)
	TAG_REFL_STRING_ID(name)
	TAG_REFL_PROPERTY(position_x)
	TAG_REFL_PROPERTY(position_y)
	TAG_REFL_PROPERTY(position_z)
...
TAG_REFL_TAG_BLOCK_DEF(s_zones_block)
	TAG_REFL_STRING_32(name)
	TAG_REFL_PROPERTY(flags)
	TAG_REFL_PROPERTY(manual_bsp_index)
	TAG_REFL_PROPERTY(unknown)
TAG_REFL_TAG_BLOCK_DEF(s_firing_positions_block)
	TAG_REFL_PROPERTY(position_x)
	TAG_REFL_PROPERTY(position_y)
	TAG_REFL_PROPERTY(position_z)
	TAG_REFL_PROPERTY(reference_frame)
...
TAG_REFL_TAG_BLOCK_DEF(s_areas_block)
	TAG_REFL_STRING_32(name)
	...
	TAG_REFL_PROPERTY(unknown)
TAG_REFL_TAG_BLOCK_DEF(s_flight_hints_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_mission_scenes_block)
	TAG_REFL_STRING_ID(name)
	TAG_REFL_PROPERTY(flags)
TAG_REFL_TAG_BLOCK_DEF(s_trigger_conditions_block)
	TAG_REFL_PROPERTY(combination_rule)
	TAG_REFL_PROPERTY(unknown)
TAG_REFL_TAG_BLOCK_DEF(s_triggers_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_roles_block)
	TAG_REFL_STRING_ID(name)
	TAG_REFL_PROPERTY(group)
	TAG_REFL_PROPERTY(unknown)
TAG_REFL_TAG_BLOCK_DEF(s_role_variants_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_character_palette_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_scripts_block)
	TAG_REFL_STRING_32(name)
...
TAG_REFL_TAG_BLOCK_DEF(s_globals_block)
	TAG_REFL_STRING_32(name)
	TAG_REFL_PROPERTY(type)
	TAG_REFL_PROPERTY(unknown)
...
TAG_REFL_TAG_BLOCK_DEF(s_script_references_block)
	TAG_REFL_TAG_REFERENCE(reference)
REFL_END
	TAG_REFL_TAG_BLOCK(script_references)
TAG_REFL_TAG_BLOCK_DEF(s_scripting_data_block)
TAG_REFL_TAG_BLOCK_DEF(s_point_sets_block)
	TAG_REFL_STRING_32(name)
TAG_REFL_TAG_BLOCK_DEF(s_points_block)
	TAG_REFL_STRING_32(name)
	TAG_REFL_PROPERTY(position_x)
	TAG_REFL_PROPERTY(position_y)
	TAG_REFL_PROPERTY(position_z)
...
TAG_REFL_TAG_BLOCK_DEF(s_cutscene_flags_block)
	TAG_REFL_STRING_32(name)
	TAG_REFL_PROPERTY(position_x)
	TAG_REFL_PROPERTY(position_y)
	TAG_REFL_PROPERTY(position_z)
...
TAG_REFL_TAG_BLOCK_DEF(s_cutscene_camera_points_block)
	TAG_REFL_PROPERTY(flags)
	TAG_REFL_PROPERTY(type)
	TAG_REFL_STRING_32(name)
	TAG_REFL_PROPERTY(position_x)
...
TAG_REFL_TAG_BLOCK_DEF(s_cutscene_titles_block)
	TAG_REFL_STRING_ID(name)
...
TAG_REFL_TAG_BLOCK_DEF(s_structure_bsps_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_scenario_resources_block)
TAG_REFL_TAG_BLOCK_DEF(s_references_block)
	TAG_REFL_TAG_REFERENCE(reference)
REFL_END
	TAG_REFL_TAG_BLOCK(references)
TAG_REFL_TAG_BLOCK_DEF(s_script_source_block)
	TAG_REFL_TAG_REFERENCE(reference)
REFL_END
	TAG_REFL_TAG_BLOCK(script_source)
TAG_REFL_TAG_BLOCK_DEF(s_ai_resources_block)
	TAG_REFL_TAG_REFERENCE(reference)
REFL_END
	TAG_REFL_TAG_BLOCK(ai_resources)
REFL_END
	TAG_REFL_TAG_BLOCK(scenario_resources)
TAG_REFL_TAG_BLOCK_DEF(s_structure_physics_block)
	TAG_REFL_DATA_BLOCK(mopp_code)
TAG_REFL_TAG_BLOCK_DEF(s_environment_object_identifiers_block)
	TAG_REFL_PROPERTY(unique_id_index)
	TAG_REFL_PROPERTY(unique_id_salt)
	TAG_REFL_PROPERTY(origin_bsp_index)
	TAG_REFL_PROPERTY(type)
...
TAG_REFL_TAG_BLOCK_DEF(s_unit_seats_mapping_block)
	TAG_REFL_TAG_REFERENCE(unit)
	TAG_REFL_PROPERTY(seats)
REFL_END
	TAG_REFL_TAG_BLOCK(unit_seats_mapping)
TAG_REFL_TAG_BLOCK_DEF(s_scenario_kill_triggers_block)
	TAG_REFL_PROPERTY(trigger_volume)
REFL_END
	TAG_REFL_TAG_BLOCK(scenario_kill_triggers)
TAG_REFL_TAG_BLOCK_DEF(s_script_expressions_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_orders_block)
	TAG_REFL_STRING_32(name)
...
TAG_REFL_TAG_BLOCK_DEF(s_primary_area_set_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_secondary_area_set_block)
	TAG_REFL_PROPERTY(area_type)
	TAG_REFL_PROPERTY(unknown)
	TAG_REFL_PROPERTY(zone_index)
	TAG_REFL_PROPERTY(area_index)
...
TAG_REFL_TAG_BLOCK_DEF(s_secondary_set_trigger_block)
	TAG_REFL_PROPERTY(combination_rule)
...
TAG_REFL_TAG_BLOCK_DEF(s_special_movement_block)
	TAG_REFL_PROPERTY(special_movement_1)
REFL_END
	TAG_REFL_TAG_BLOCK(special_movement)
TAG_REFL_TAG_BLOCK_DEF(s_order_endings_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_ai_triggers_block)
	TAG_REFL_STRING_32(name)
	TAG_REFL_PROPERTY(trigger_flags)
	TAG_REFL_PROPERTY(combination_rule)
	TAG_REFL_PROPERTY(unknown)
TAG_REFL_TAG_BLOCK_DEF(s_conditions_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_background_sound_palette_block)
	TAG_REFL_STRING_32(name)
...
TAG_REFL_TAG_BLOCK_DEF(s_sound_environment_palette_block)
	TAG_REFL_STRING_32(name)
...
TAG_REFL_TAG_BLOCK_DEF(s_weather_palette_block)
	TAG_REFL_STRING_32(name)
...
TAG_REFL_TAG_BLOCK_DEF(s_scenario_cluster_data_block)
	TAG_REFL_TAG_REFERENCE(bsp)
TAG_REFL_TAG_BLOCK_DEF(s_background_sounds_block)
	TAG_REFL_PROPERTY(palette_index)
	TAG_REFL_PROPERTY(unknown)
REFL_END
	TAG_REFL_TAG_BLOCK(background_sounds)
TAG_REFL_TAG_BLOCK_DEF(s_sound_environments_block)
	TAG_REFL_PROPERTY(palette_index)
	TAG_REFL_PROPERTY(unknown)
REFL_END
	TAG_REFL_TAG_BLOCK(sound_environments)
	TAG_REFL_PROPERTY(bsp_checksum)
TAG_REFL_TAG_BLOCK_DEF(s_cluster_centroids_block)
	TAG_REFL_PROPERTY(centroid_x)
	TAG_REFL_PROPERTY(centroid_y)
	TAG_REFL_PROPERTY(centroid_z)
REFL_END
	TAG_REFL_TAG_BLOCK(cluster_centroids)
TAG_REFL_TAG_BLOCK_DEF(s_weather_properties_block)
	TAG_REFL_PROPERTY(palette_index)
	TAG_REFL_PROPERTY(unknown)
REFL_END
	TAG_REFL_TAG_BLOCK(weather_properties)
TAG_REFL_TAG_BLOCK_DEF(s_atmospheric_fog_properties_block)
	TAG_REFL_PROPERTY(palette_index)
	TAG_REFL_PROPERTY(unknown)
REFL_END
...
TAG_REFL_TAG_BLOCK_DEF(s_spawn_data_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_dynamic_spawn_overloads_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_static_respawn_zones_block)
	TAG_REFL_STRING_ID(name)
...
TAG_REFL_TAG_BLOCK_DEF(s_static_initial_spawn_zones_block)
	TAG_REFL_STRING_ID(name)
	TAG_REFL_PROPERTY(relevant_team)
	TAG_REFL_PROPERTY(relevant_games)
	TAG_REFL_PROPERTY(flags)
...
TAG_REFL_TAG_BLOCK_DEF(s_crates_block)
	TAG_REFL_PROPERTY(palette_index)
	TAG_REFL_PROPERTY(name_index)
	TAG_REFL_PROPERTY(placement_flags)
	TAG_REFL_PROPERTY(position_x)
...
TAG_REFL_TAG_BLOCK_DEF(s_crate_palette_block)
	TAG_REFL_TAG_REFERENCE(crate)
REFL_END
	TAG_REFL_TAG_BLOCK(crate_palette)
	TAG_REFL_TAG_REFERENCE(global_lighting)
TAG_REFL_TAG_BLOCK_DEF(s_atmospheric_fog_palette_block)
	TAG_REFL_STRING_ID(name)
	TAG_REFL_PROPERTY(color_red)
	TAG_REFL_PROPERTY(color_green)
	TAG_REFL_PROPERTY(color_blue)
...
TAG_REFL_TAG_BLOCK_DEF(s_mixers_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_planar_fog_palette_block)
	TAG_REFL_STRING_ID(name)
...
TAG_REFL_TAG_BLOCK_DEF(s_flocks_block)
	TAG_REFL_PROPERTY(bsp_index)
	TAG_REFL_PROPERTY(unknown)
	TAG_REFL_PROPERTY(bounding_trigger_volume)
	TAG_REFL_PROPERTY(flags)
	TAG_REFL_PROPERTY(ecology_margin)
TAG_REFL_TAG_BLOCK_DEF(s_sources_block)
	TAG_REFL_PROPERTY(position_x)
	TAG_REFL_PROPERTY(position_y)
	TAG_REFL_PROPERTY(position_z)
...
TAG_REFL_TAG_BLOCK_DEF(s_sinks_block)
	TAG_REFL_PROPERTY(position_x)
	TAG_REFL_PROPERTY(position_y)
	TAG_REFL_PROPERTY(position_z)
	TAG_REFL_PROPERTY(radius)
...
TAG_REFL_TAG_BLOCK_DEF(s_creature_palette_block)
	TAG_REFL_TAG_REFERENCE(creature)
REFL_END
	TAG_REFL_TAG_BLOCK(creature_palette)
TAG_REFL_TAG_BLOCK_DEF(s_decorator_palette_block)
	TAG_REFL_TAG_REFERENCE(decorator_set)
REFL_END
	TAG_REFL_TAG_BLOCK(decorator_palette)
TAG_REFL_TAG_BLOCK_DEF(s_bsp_transition_volumes_block)
	TAG_REFL_PROPERTY(unknown)
...
TAG_REFL_TAG_BLOCK_DEF(s_structure_bsp_lighting_block)
	TAG_REFL_TAG_REFERENCE(bsp)
TAG_REFL_TAG_BLOCK_DEF(s_lighting_points_block)
	TAG_REFL_PROPERTY(position_x)
	TAG_REFL_PROPERTY(position_y)
	TAG_REFL_PROPERTY(position_z)
REFL_END
...
TAG_REFL_TAG_BLOCK_DEF(s_editor_folders_block)
	TAG_REFL_PROPERTY(parent_folder)
	TAG_REFL_STRING_256(name)
REFL_END
	TAG_REFL_TAG_BLOCK(editor_folders)
TAG_REFL_TAG_BLOCK_DEF(s_level_data_block)
	TAG_REFL_TAG_REFERENCE(level_description)
TAG_REFL_TAG_BLOCK_DEF(s_campaign_level_data_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_multiplayer_block)
	TAG_REFL_PROPERTY(map_id)
	TAG_REFL_TAG_REFERENCE(bitmap)
	TAG_REFL_USTRING_32(english_name)
	TAG_REFL_USTRING_32(japanese_name)
...
TAG_REFL_TAG_BLOCK_DEF(s_screen_effect_references_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_simulation_definition_table_block)
