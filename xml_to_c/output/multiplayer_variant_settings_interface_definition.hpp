...
TAG_REFL_TAG_BLOCK_DEF(s_multiplayer_variant_settings_interface_group_definition::s_game_engine_settings_block::s_options_block)	TAG_REFL_TAG_REFERENCE(value_pairs)REFL_END
...
TAG_REFL_TAG_BLOCK_DEF(s_multiplayer_variant_settings_interface_group_definition::s_default_variants_block::s_settings_block)	TAG_REFL_PROPERTY(setting_catergory)	TAG_REFL_PROPERTY(value)REFL_END
