...
TAG_REFL_TAG_BLOCK_DEF(s_render_model_group_definition::s_section_groups_block::s_compound_nodes_block)	TAG_REFL_PROPERTY(node_index)	TAG_REFL_PROPERTY(node_index)	TAG_REFL_PROPERTY(node_index)	TAG_REFL_PROPERTY(node_index)	TAG_REFL_PROPERTY(node_weight)	TAG_REFL_PROPERTY(node_weight)	TAG_REFL_PROPERTY(node_weight)REFL_END
...
TAG_REFL_TAG_BLOCK_DEF(s_render_model_group_definition::s_prt_info_block::s_lod_info_block::s_section_info_block)	TAG_REFL_PROPERTY(section_index)	TAG_REFL_PROPERTY(pca_data_offset)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_render_model_group_definition::s_prt_info_block::s_lod_info_block)	TAG_REFL_PROPERTY(cluster_offset)	TAG_REFL_TAG_BLOCK(section_info)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_render_model_group_definition::s_prt_info_block::s_cluster_basis_block)	TAG_REFL_PROPERTY(basis_data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_render_model_group_definition::s_prt_info_block::s_resources_block)	TAG_REFL_PROPERTY(type)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(primary_locator)	TAG_REFL_PROPERTY(secondary_locator)	TAG_REFL_PROPERTY(resoure_data_size)	TAG_REFL_PROPERTY(resource_data_offset)REFL_END
...
TAG_REFL_TAG_BLOCK_DEF(s_render_model_group_definition::s_section_render_leaves_block::s_node_render_leaves_block::s_collision_leaves_block)	TAG_REFL_PROPERTY(cluster)	TAG_REFL_PROPERTY(surface_reference_count)	TAG_REFL_PROPERTY(first_surface_reference_index)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_render_model_group_definition::s_section_render_leaves_block::s_node_render_leaves_block::s_surface_references_block)	TAG_REFL_PROPERTY(strip_index)	TAG_REFL_PROPERTY(lightmap_triangle_index)	TAG_REFL_PROPERTY(bsp_node_index)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_render_model_group_definition::s_section_render_leaves_block::s_node_render_leaves_block)	TAG_REFL_TAG_BLOCK(collision_leaves)	TAG_REFL_TAG_BLOCK(surface_references)REFL_END
