...
TAG_REFL_TAG_BLOCK_DEF(s_globals_group_definition::s_damage_table_block::s_damage_groups_block::s_armor_modifiers_block)	TAG_REFL_STRING_ID(name)	TAG_REFL_PROPERTY(damage_multiplier)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_globals_group_definition::s_damage_table_block::s_damage_groups_block)	TAG_REFL_STRING_ID(name)	TAG_REFL_TAG_BLOCK(armor_modifiers)REFL_END
...
TAG_REFL_TAG_BLOCK_DEF(s_globals_group_definition::s_player_control_block::s_look_function_block)	TAG_REFL_PROPERTY(scale)REFL_END
...
TAG_REFL_TAG_BLOCK_DEF(s_globals_group_definition::s_rasterizer_data_block::s_global_vertex_shaders_block)	TAG_REFL_TAG_REFERENCE(vertex_shader)REFL_END
...
TAG_REFL_TAG_BLOCK_DEF(s_globals_group_definition::s_multiplayer_information_block::s_vehicles_block)	TAG_REFL_TAG_REFERENCE(vehicle)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_globals_group_definition::s_multiplayer_information_block::s_sounds_block)	TAG_REFL_TAG_REFERENCE(sound)REFL_END
...
TAG_REFL_TAG_BLOCK_DEF(s_globals_group_definition::s_multiplayer_ui_block::s_obsolete_profile_colors_block)	TAG_REFL_REAL_COLOR_RGB(color)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_globals_group_definition::s_multiplayer_ui_block::s_team_colors_block)	TAG_REFL_REAL_COLOR_RGB(color)REFL_END
