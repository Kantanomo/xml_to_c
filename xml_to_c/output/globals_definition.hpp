...
TAG_REFL_TAG_BLOCK_DEF(s_havok_cleanup_resources_block)
	TAG_REFL_TAG_REFERENCE(object_cleanup_effect)
REFL_END
	TAG_REFL_TAG_BLOCK(havok_cleanup_resources)
TAG_REFL_TAG_BLOCK_DEF(s_collision_damage_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_sound_globals_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_ai_globals_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_gravemind_properties_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_damage_table_block)
TAG_REFL_TAG_BLOCK_DEF(s_damage_groups_block)
	TAG_REFL_STRING_ID(name)
TAG_REFL_TAG_BLOCK_DEF(s_armor_modifiers_block)
	TAG_REFL_STRING_ID(name)
...
TAG_REFL_TAG_BLOCK_DEF(s_sounds_block)
	TAG_REFL_TAG_REFERENCE(sound_obsolete)
REFL_END
	TAG_REFL_TAG_BLOCK(sounds)
TAG_REFL_TAG_BLOCK_DEF(s_camera_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_player_control_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_look_function_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_difficulty_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_grenades_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_rasterizer_data_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_global_vertex_shaders_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_interface_tags_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_weapon_list_block)
	TAG_REFL_TAG_REFERENCE(weapon)
REFL_END
	TAG_REFL_TAG_BLOCK(weapon_list)
TAG_REFL_TAG_BLOCK_DEF(s_cheat_powerups_block)
	TAG_REFL_TAG_REFERENCE(powerup)
REFL_END
	TAG_REFL_TAG_BLOCK(cheat_powerups)
TAG_REFL_TAG_BLOCK_DEF(s_multiplayer_information_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_player_information_block)
	TAG_REFL_TAG_REFERENCE(unit)
...
TAG_REFL_TAG_BLOCK_DEF(s_player_representation_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_falling_damage_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_old_materials_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_multiplayer_ui_block)
	TAG_REFL_TAG_REFERENCE(random_player_names)
TAG_REFL_TAG_BLOCK_DEF(s_obsolete_profile_colors_block)
	TAG_REFL_REAL_COLOR_RGB(color)
REFL_END
	TAG_REFL_TAG_BLOCK(obsolete_profile_colors)
TAG_REFL_TAG_BLOCK_DEF(s_team_colors_block)
	TAG_REFL_REAL_COLOR_RGB(color)
REFL_END
...
TAG_REFL_TAG_BLOCK_DEF(s_profile_colors_block)
	TAG_REFL_REAL_COLOR_RGB(color)
REFL_END
	TAG_REFL_TAG_BLOCK(profile_colors)
	TAG_REFL_TAG_REFERENCE(multiplayer_globals)
TAG_REFL_TAG_BLOCK_DEF(s_runtime_level_data_block)
TAG_REFL_TAG_BLOCK_DEF(s_campaign_levels_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_ui_level_data_block)
TAG_REFL_TAG_BLOCK_DEF(s_campaigns_block)
	TAG_REFL_PROPERTY(campaign_id)
...
REFL_END
	TAG_REFL_TAG_BLOCK(campaign_levels)
TAG_REFL_TAG_BLOCK_DEF(s_multiplayer_levels_block)
	TAG_REFL_PROPERTY(map_id)
	TAG_REFL_TAG_REFERENCE(bitmap)
	TAG_REFL_USTRING_32(english_name)
	TAG_REFL_USTRING_32(japanese_name)
