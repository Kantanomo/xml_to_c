...
TAG_REFL_TAG_BLOCK_DEF(s_menu_content_block)
	TAG_REFL_PROPERTY(unused)
	TAG_REFL_PROPERTY(transition_type)
TAG_REFL_TAG_BLOCK_DEF(s_buttons_1_block)
	TAG_REFL_PROPERTY(unused)
	TAG_REFL_PROPERTY(unused)
...
TAG_REFL_TAG_BLOCK_DEF(s_buttons_2_block)
...
REFL_END
	...
	TAG_REFL_PROPERTY(unused)
	TAG_REFL_PROPERTY(unused)
TAG_REFL_TAG_BLOCK_DEF(s_text_strings_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_ui_bitmaps_block)
	TAG_REFL_PROPERTY(unknown)
	TAG_REFL_PROPERTY(unused)
	TAG_REFL_PROPERTY(transition_type_bitmask)
	TAG_REFL_PROPERTY(variation)
...
TAG_REFL_TAG_BLOCK_DEF(s_modelsscript_objects:_scenerybipeds_block)
	TAG_REFL_PROPERTY(unused)
	TAG_REFL_PROPERTY(unused)
	TAG_REFL_PROPERTY(transition_type_bitmask)
	TAG_REFL_PROPERTY(variation)
	TAG_REFL_PROPERTY(unknown)
	TAG_REFL_PROPERTY(unused)
TAG_REFL_TAG_BLOCK_DEF(s_script_object_block)
...
REFL_END
	...
	TAG_REFL_PROPERTY(unused)
	TAG_REFL_PROPERTY(unused)
TAG_REFL_TAG_BLOCK_DEF(s_variable_buttons_block)
	TAG_REFL_PROPERTY(unused)
...
TAG_REFL_TAG_BLOCK_DEF(s_descriptionshelp_text_block)
	TAG_REFL_STRING_ID(text_strings)
TAG_REFL_TAG_BLOCK_DEF(s_notification_messages_block)
	TAG_REFL_STRING_ID(text_strings)
REFL_END
	TAG_REFL_TAG_BLOCK(notification_messages)
REFL_END
	TAG_REFL_TAG_BLOCK(descriptionshelp_text)
TAG_REFL_TAG_BLOCK_DEF(s_prededicated_resources:_bitmap_tags_block)
	TAG_REFL_TAG_REFERENCE(bitm)
REFL_END
