...
TAG_REFL_TAG_BLOCK_DEF(s_user_interface_screen_widget_group_definition::s_descriptionshelp_text_group_definition::s_notification_messages_block)	TAG_REFL_STRING_ID(text_strings)REFL_END
