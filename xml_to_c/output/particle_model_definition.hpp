...
TAG_REFL(s_particle_model_group_definition)
	...
	TAG_REFL_PROPERTY(value)
	TAG_REFL_PROPERTY(output_modifier)
TAG_REFL_TAG_BLOCK_DEF(s_scale_x_block)
...
REFL_END
	...
	TAG_REFL_PROPERTY(value)
	TAG_REFL_PROPERTY(output_modifier)
TAG_REFL_TAG_BLOCK_DEF(s_scale_y_block)
	TAG_REFL_PROPERTY(data)
REFL_END
	...
	TAG_REFL_PROPERTY(value)
	TAG_REFL_PROPERTY(output_modifier)
TAG_REFL_TAG_BLOCK_DEF(s_scale_z_block)
	TAG_REFL_PROPERTY(data)
REFL_END
...
TAG_REFL_TAG_BLOCK_DEF(s_attached_particle_system_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_models_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_cached_data_block)
REFL_END
