...
TAG_REFL_TAG_BLOCK_DEF(s_buttons_text_strings_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_button_bitmaps_block)
	TAG_REFL_PROPERTY(unknown)
	TAG_REFL_PROPERTY(unknown)
	TAG_REFL_PROPERTY(transition_effectmovement)
...
TAG_REFL_TAG_BLOCK_DEF(s_emblem_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_buttons_holder_block)
	TAG_REFL_PROPERTY(unused)
