...
TAG_REFL_TAG_BLOCK_DEF(s_vehicle_group_definition::s_change_colors_group_definition::s_initial_permutations_block)	TAG_REFL_PROPERTY(weight)	TAG_REFL_REAL_COLOR_RGB(color_lower_bound)	TAG_REFL_REAL_COLOR_RGB(color_upper_bound)	TAG_REFL_STRING_ID(variant_name)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_vehicle_group_definition::s_change_colors_group_definition::s_functions_block)	TAG_REFL_PROPERTY(scale_flags)	TAG_REFL_REAL_COLOR_RGB(color_lower_bound)	TAG_REFL_REAL_COLOR_RGB(color_upper_bound)	TAG_REFL_STRING_ID(darken_by)	TAG_REFL_STRING_ID(scale_by)REFL_END
...
TAG_REFL_TAG_BLOCK_DEF(s_vehicle_group_definition::s_seats_group_definition::s_camera_tracks_block)	TAG_REFL_TAG_REFERENCE(track)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_vehicle_group_definition::s_seats_group_definition::s_unit_hud_interface_block)	TAG_REFL_TAG_REFERENCE(new_unit_hud_interface)REFL_END
