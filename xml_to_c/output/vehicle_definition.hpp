...
TAG_REFL_TAG_BLOCK_DEF(s_camera_tracks_block)
...
REFL_END
	...
	TAG_REFL_PROPERTY(unknown)
TAG_REFL_TAG_BLOCK_DEF(s_postures_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_new_hud_interfaces_block)
	TAG_REFL_TAG_REFERENCE(new_unit_hud_interface)
REFL_END
	TAG_REFL_TAG_BLOCK(new_hud_interfaces)
TAG_REFL_TAG_BLOCK_DEF(s_dialogue_variants_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_powered_seats_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_seats_block)
	TAG_REFL_PROPERTY(flags)
...
REFL_END
	TAG_REFL_TAG_BLOCK(camera_tracks)
TAG_REFL_TAG_BLOCK_DEF(s_unit_hud_interface_block)
	TAG_REFL_TAG_REFERENCE(new_unit_hud_interface)
REFL_END
...
TAG_REFL_TAG_BLOCK_DEF(s_gears_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_antigrav_points_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_friction_points_block)
	TAG_REFL_STRING_ID(marker_name)
	TAG_REFL_PROPERTY(flags)
...
TAG_REFL_TAG_BLOCK_DEF(s_phantom_shapes_block)
	TAG_REFL_PROPERTY(unknown)
	TAG_REFL_PROPERTY(size)
