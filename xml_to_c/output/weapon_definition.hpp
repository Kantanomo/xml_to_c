...
TAG_REFL_TAG_BLOCK_DEF(s_weapon_group_definition::s_predicted_resource_block)	TAG_REFL_PROPERTY(type)	TAG_REFL_PROPERTY(resource_index)	TAG_REFL_TAG_REFERENCE(tag_index)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_weapon_group_definition::s_magazines_block::s_magazine_equipment_block)	TAG_REFL_PROPERTY(rounds_0_for_max)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_TAG_REFERENCE(equipment)REFL_END
