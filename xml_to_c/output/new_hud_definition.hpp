...
TAG_REFL_TAG_BLOCK_DEF(s_bitmap_widgets_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_effect_block)
	TAG_REFL_PROPERTY(flags)
...
TAG_REFL_TAG_BLOCK_DEF(s_numerical_elements_block)
	TAG_REFL_STRING_ID(name)
	TAG_REFL_PROPERTY(input_1)
	TAG_REFL_PROPERTY(input_2)
	TAG_REFL_PROPERTY(input_3)
...
TAG_REFL_TAG_BLOCK_DEF(s_effect_block)
	...
	TAG_REFL_STRING_ID(range_name)
	TAG_REFL_PROPERTY(time_period_in_seconds)
TAG_REFL_TAG_BLOCK_DEF(s_function_block)
...
REFL_END
	...
	TAG_REFL_PROPERTY(age_cutoff)
TAG_REFL_TAG_BLOCK_DEF(s_unknown98_block)
	TAG_REFL_STRING_ID(name)
	TAG_REFL_PROPERTY(input_1)
	TAG_REFL_PROPERTY(input_2)
	TAG_REFL_PROPERTY(input_3)
