...
TAG_REFL_TAG_BLOCK_DEF(s_new_hud_group_definition::s_numerical_elements_group_definition::s_effect_group_definition::s_function_block)	TAG_REFL_PROPERTY(data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_new_hud_group_definition::s_numerical_elements_group_definition::s_effect_group_definition::s_function_block)	TAG_REFL_PROPERTY(data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_new_hud_group_definition::s_numerical_elements_group_definition::s_effect_group_definition::s_function_block)	TAG_REFL_PROPERTY(data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_new_hud_group_definition::s_numerical_elements_group_definition::s_effect_group_definition::s_function_block)	TAG_REFL_PROPERTY(data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_new_hud_group_definition::s_numerical_elements_group_definition::s_effect_group_definition::s_function_block)	TAG_REFL_PROPERTY(data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_new_hud_group_definition::s_numerical_elements_group_definition::s_effect_block)	TAG_REFL_PROPERTY(flags)	TAG_REFL_STRING_ID(input_name)	TAG_REFL_STRING_ID(range_name)	TAG_REFL_PROPERTY(time_period_in_seconds)	TAG_REFL_TAG_BLOCK(function)	TAG_REFL_STRING_ID(input_name)	TAG_REFL_STRING_ID(range_name)	TAG_REFL_PROPERTY(time_period_in_seconds)	TAG_REFL_TAG_BLOCK(function)	TAG_REFL_STRING_ID(input_name)	TAG_REFL_STRING_ID(range_name)	TAG_REFL_PROPERTY(time_period_in_seconds)	TAG_REFL_TAG_BLOCK(function)	TAG_REFL_STRING_ID(input_name)	TAG_REFL_STRING_ID(range_name)	TAG_REFL_PROPERTY(time_period_in_seconds)	TAG_REFL_TAG_BLOCK(function)	TAG_REFL_STRING_ID(input_name)	TAG_REFL_STRING_ID(range_name)	TAG_REFL_PROPERTY(time_period_in_seconds)	TAG_REFL_TAG_BLOCK(function)REFL_END
