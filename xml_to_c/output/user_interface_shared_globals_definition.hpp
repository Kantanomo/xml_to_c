...
TAG_REFL_TAG_BLOCK_DEF(s_user_interface_shared_globals_group_definition::s_virtual_keyboard_buttons_settings_block::s_button_switching_effects_block)	TAG_REFL_PROPERTY(unused)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(unknown)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_user_interface_shared_globals_group_definition::s_virtual_keyboard_buttons_settings_block::s_button_switching_effects_block)	TAG_REFL_PROPERTY(unused)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(unknown)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_user_interface_shared_globals_group_definition::s_virtual_keyboard_buttons_settings_block::s_unused_block)	TAG_REFL_PROPERTY(unused)	TAG_REFL_PROPERTY(unused)	TAG_REFL_PROPERTY(unused)	TAG_REFL_PROPERTY(unused)	TAG_REFL_PROPERTY(unused)REFL_END
...
TAG_REFL_TAG_BLOCK_DEF(s_user_interface_shared_globals_group_definition::s_button_effects_block::s_button_switching_effects_block)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(unused)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(unused)	TAG_REFL_PROPERTY(unused)	TAG_REFL_PROPERTY(unknown)REFL_END
