...
TAG_REFL(s_user_interface_shared_globals_group_definition)
	...
	TAG_REFL_PROPERTY(unused)
	TAG_REFL_PROPERTY(unused)
TAG_REFL_TAG_BLOCK_DEF(s_dialogs_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_variations_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_virtual_keyboard_buttons_settings_block)
	TAG_REFL_PROPERTY(unused)
	TAG_REFL_PROPERTY(unused)
	TAG_REFL_PROPERTY(selected_button_brightness)
	TAG_REFL_PROPERTY(unused)
TAG_REFL_TAG_BLOCK_DEF(s_button_switching_effects_block)
	TAG_REFL_PROPERTY(unused)
	TAG_REFL_PROPERTY(unknown)
	TAG_REFL_PROPERTY(unknown)
	TAG_REFL_PROPERTY(unknown)
...
REFL_END
	...
	TAG_REFL_PROPERTY(unknown)
	TAG_REFL_PROPERTY(unused)
TAG_REFL_TAG_BLOCK_DEF(s_unused_block)
	TAG_REFL_PROPERTY(unused)
	TAG_REFL_PROPERTY(unused)
	TAG_REFL_PROPERTY(unused)
	TAG_REFL_PROPERTY(unused)
...
TAG_REFL_TAG_BLOCK_DEF(s_button_effects_block)
	TAG_REFL_PROPERTY(unused)
	TAG_REFL_PROPERTY(unused)
...
TAG_REFL_TAG_BLOCK_DEF(s_buttons_palette_block)
