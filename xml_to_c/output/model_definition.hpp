...
TAG_REFL_TAG_BLOCK_DEF(s_objects_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_new_damage_info_block)
	TAG_REFL_PROPERTY(flags)
...
TAG_REFL_TAG_BLOCK_DEF(s_damage_secctions_block)
	TAG_REFL_STRING_ID(name)
	TAG_REFL_PROPERTY(flags)
	TAG_REFL_PROPERTY(vitality_percentage)
TAG_REFL_TAG_BLOCK_DEF(s_instant_responses_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_damage_seats_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_damage_constraints_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_targets_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_model_variations_block)
...
REFL_END
	TAG_REFL_TAG_BLOCK(nodes)
TAG_REFL_TAG_BLOCK_DEF(s_model_object_data_block)
	TAG_REFL_PROPERTY(type)
	TAG_REFL_PROPERTY(x)
	TAG_REFL_PROPERTY(y)
	TAG_REFL_PROPERTY(z)
