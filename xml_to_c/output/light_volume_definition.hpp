...
TAG_REFL_TAG_BLOCK_DEF(s_volumes_block)
	TAG_REFL_PROPERTY(flags)
	TAG_REFL_TAG_REFERENCE(bitmap)
	TAG_REFL_PROPERTY(sprite_count)
TAG_REFL_TAG_BLOCK_DEF(s_offset_block)
	TAG_REFL_PROPERTY(data)
REFL_END
	TAG_REFL_TAG_BLOCK(offset)
TAG_REFL_TAG_BLOCK_DEF(s_radius_block)
	TAG_REFL_PROPERTY(data)
REFL_END
...
TAG_REFL_TAG_BLOCK_DEF(s_facing_block)
	TAG_REFL_PROPERTY(data)
REFL_END
	TAG_REFL_TAG_BLOCK(facing)
TAG_REFL_TAG_BLOCK_DEF(s_aspect_block)
TAG_REFL_TAG_BLOCK_DEF(s_alongaxis_scale_block)
	TAG_REFL_PROPERTY(data)
REFL_END
	TAG_REFL_TAG_BLOCK(alongaxis_scale)
TAG_REFL_TAG_BLOCK_DEF(s_awayfromaxis_scale_block)
	TAG_REFL_PROPERTY(data)
REFL_END
...
TAG_REFL_TAG_BLOCK_DEF(s_NUM__block)
REFL_END
