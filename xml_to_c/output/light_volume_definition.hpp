...
TAG_REFL_TAG_BLOCK_DEF(s_light_volume_group_definition::s_volumes_group_definition::s_offset_block)	TAG_REFL_PROPERTY(data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_light_volume_group_definition::s_volumes_group_definition::s_radius_block)	TAG_REFL_PROPERTY(data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_light_volume_group_definition::s_volumes_group_definition::s_brightness_block)	TAG_REFL_PROPERTY(data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_light_volume_group_definition::s_volumes_group_definition::s_color_block)	TAG_REFL_PROPERTY(data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_light_volume_group_definition::s_volumes_group_definition::s_facing_block)	TAG_REFL_PROPERTY(data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_light_volume_group_definition::s_volumes_group_definition::s_aspect_group_definition::s_alongaxis_scale_block)	TAG_REFL_PROPERTY(data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_light_volume_group_definition::s_volumes_group_definition::s_aspect_group_definition::s_awayfromaxis_scale_block)	TAG_REFL_PROPERTY(data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_light_volume_group_definition::s_volumes_group_definition::s_aspect_block)	TAG_REFL_TAG_BLOCK(alongaxis_scale)	TAG_REFL_TAG_BLOCK(awayfromaxis_scale)	TAG_REFL_PROPERTY(parallel_scale)	TAG_REFL_PROPERTY(parallel_threshold_angle)	TAG_REFL_PROPERTY(parallel_exponent)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_light_volume_group_definition::s_volumes_group_definition::s_NUM__block)REFL_END
