...
TAG_REFL_TAG_BLOCK_DEF(s_universal_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_runtime_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_powerups_block)
	TAG_REFL_TAG_REFERENCE(weapon)
REFL_END
...
TAG_REFL_TAG_BLOCK_DEF(s_general_events_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_sound_permutations_block)
	TAG_REFL_PROPERTY(sound_flags)
	TAG_REFL_PROPERTY(unknown)
...
TAG_REFL_TAG_BLOCK_DEF(s_flavor_events_block)
	TAG_REFL_PROPERTY(flags)
	TAG_REFL_PROPERTY(type)
	TAG_REFL_PROPERTY(event)
	TAG_REFL_PROPERTY(audience)
...
TAG_REFL_TAG_BLOCK_DEF(s_slayer_events_block)
	TAG_REFL_PROPERTY(flags)
	TAG_REFL_PROPERTY(type)
	TAG_REFL_PROPERTY(event)
	TAG_REFL_PROPERTY(audience)
...
TAG_REFL_TAG_BLOCK_DEF(s_ctf_events_block)
	TAG_REFL_PROPERTY(flags)
	TAG_REFL_PROPERTY(type)
	TAG_REFL_PROPERTY(event)
	TAG_REFL_PROPERTY(audience)
...
TAG_REFL_TAG_BLOCK_DEF(s_oddball_events_block)
	TAG_REFL_PROPERTY(flags)
	TAG_REFL_PROPERTY(type)
	TAG_REFL_PROPERTY(event)
	TAG_REFL_PROPERTY(audience)
...
TAG_REFL_TAG_BLOCK_DEF(s_king_of_the_hill_events_block)
	TAG_REFL_PROPERTY(flags)
	TAG_REFL_PROPERTY(type)
	TAG_REFL_PROPERTY(event)
	TAG_REFL_PROPERTY(audience)
...
TAG_REFL_TAG_BLOCK_DEF(s_juggernaut_events_block)
	TAG_REFL_PROPERTY(flags)
	TAG_REFL_PROPERTY(type)
	TAG_REFL_PROPERTY(event)
	TAG_REFL_PROPERTY(audience)
...
TAG_REFL_TAG_BLOCK_DEF(s_territories_events_block)
	TAG_REFL_PROPERTY(flags)
	TAG_REFL_PROPERTY(type)
	TAG_REFL_PROPERTY(event)
	TAG_REFL_PROPERTY(audience)
...
TAG_REFL_TAG_BLOCK_DEF(s_assualt_events_block)
	TAG_REFL_PROPERTY(flags)
	TAG_REFL_PROPERTY(type)
	TAG_REFL_PROPERTY(event)
	TAG_REFL_PROPERTY(audience)
...
TAG_REFL_TAG_BLOCK_DEF(s_multiplayer_constants_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_state_responses_block)
	TAG_REFL_PROPERTY(flags)
	TAG_REFL_PROPERTY(unknown)
