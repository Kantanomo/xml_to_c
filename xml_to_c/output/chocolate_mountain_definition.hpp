...
TAG_REFL_TAG_BLOCK_DEF(s_chocolate_mountain_group_definition::s_light_variables_group_definition::s_primary_light_function_block)	TAG_REFL_PROPERTY(data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_chocolate_mountain_group_definition::s_light_variables_group_definition::s_secondary_light_function_block)	TAG_REFL_PROPERTY(data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_chocolate_mountain_group_definition::s_light_variables_group_definition::s_ambient_light_function_block)	TAG_REFL_PROPERTY(data)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_chocolate_mountain_group_definition::s_light_variables_group_definition::s_lightmap_shadows_block)	TAG_REFL_PROPERTY(data)REFL_END
