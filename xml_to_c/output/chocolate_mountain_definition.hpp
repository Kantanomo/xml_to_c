...
TAG_REFL_TAG_BLOCK_DEF(s_light_variables_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_primary_light_function_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_secondary_light_function_block)
	TAG_REFL_PROPERTY(data)
REFL_END
...
TAG_REFL_TAG_BLOCK_DEF(s_ambient_light_function_block)
	TAG_REFL_PROPERTY(data)
REFL_END
	TAG_REFL_TAG_BLOCK(ambient_light_function)
TAG_REFL_TAG_BLOCK_DEF(s_lightmap_shadows_block)
	TAG_REFL_PROPERTY(data)
REFL_END
