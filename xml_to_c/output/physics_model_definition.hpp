...
TAG_REFL_TAG_BLOCK_DEF(s_lift_properties_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_unknown9_block)
TAG_REFL_TAG_BLOCK_DEF(s_unknown10_block)
REFL_END
...
TAG_REFL_TAG_BLOCK_DEF(s_rigid_bodies_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_spheres_block)
	TAG_REFL_STRING_ID(unknown)
	TAG_REFL_PROPERTY(unknown)
	TAG_REFL_PROPERTY(unknown)
	TAG_REFL_PROPERTY(unknown)
...
TAG_REFL_TAG_BLOCK_DEF(s_multisphere_block)
	TAG_REFL_PROPERTY(unknown)
REFL_END
	TAG_REFL_TAG_BLOCK(multisphere)
TAG_REFL_TAG_BLOCK_DEF(s_capsules_block)
	TAG_REFL_STRING_ID(name)
...
TAG_REFL_TAG_BLOCK_DEF(s_boxes_block)
	TAG_REFL_STRING_ID(name)
	TAG_REFL_PROPERTY(material)
	TAG_REFL_PROPERTY(global_material_index)
	TAG_REFL_PROPERTY(unknown)
...
TAG_REFL_TAG_BLOCK_DEF(s_triangles_block)
REFL_END
	TAG_REFL_TAG_BLOCK(triangles)
TAG_REFL_TAG_BLOCK_DEF(s_convex_shapes_block)
	TAG_REFL_STRING_ID(name)
	TAG_REFL_PROPERTY(material)
	TAG_REFL_PROPERTY(global_material_index)
	TAG_REFL_PROPERTY(unknown)
...
TAG_REFL_TAG_BLOCK_DEF(s_scalers_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_list_shape_block)
REFL_END
	TAG_REFL_TAG_BLOCK(list_shape)
TAG_REFL_TAG_BLOCK_DEF(s_unknown239_block)
REFL_END
	TAG_REFL_TAG_BLOCK(unknown239)
TAG_REFL_TAG_BLOCK_DEF(s_bv_tree_block)
REFL_END
	TAG_REFL_TAG_BLOCK(bv_tree)
TAG_REFL_TAG_BLOCK_DEF(s_unknown253_block)
	TAG_REFL_PROPERTY(unknown)
REFL_END
	TAG_REFL_TAG_BLOCK(unknown253)
TAG_REFL_TAG_BLOCK_DEF(s_unknown25_block)
	TAG_REFL_STRING_ID(unknown)
REFL_END
	TAG_REFL_TAG_BLOCK(unknown25)
TAG_REFL_TAG_BLOCK_DEF(s_damage_permutations_block)
	TAG_REFL_STRING_ID(part)
TAG_REFL_TAG_BLOCK_DEF(s_damage_levels_block)
	TAG_REFL_STRING_ID(level_of_damage)
TAG_REFL_TAG_BLOCK_DEF(s_phmo_variation_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_bones_block)
