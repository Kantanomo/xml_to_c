...
TAG_REFL_TAG_BLOCK_DEF(s_physics_model_group_definition::s_unknown9_group_definition::s_unknown10_block)REFL_END
...
TAG_REFL_TAG_BLOCK_DEF(s_physics_model_group_definition::s_damage_permutations_group_definition::s_damage_levels_group_definition::s_phmo_variation_block)	TAG_REFL_PROPERTY(phmo_variation_chunk)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_physics_model_group_definition::s_damage_permutations_group_definition::s_damage_levels_block)	TAG_REFL_STRING_ID(level_of_damage)	TAG_REFL_TAG_BLOCK(phmo_variation)REFL_END
