...
TAG_REFL_TAG_BLOCK_DEF(s_sound_cache_file_gestalt_group_definition::s_promotions_group_definition::s_rules_block)	TAG_REFL_PROPERTY(pitch_range_index)	TAG_REFL_PROPERTY(maximum_playing_count)	TAG_REFL_PROPERTY(suppression_time)	TAG_REFL_PROPERTY(unknown)	TAG_REFL_PROPERTY(unknown)REFL_END
TAG_REFL_TAG_BLOCK_DEF(s_sound_cache_file_gestalt_group_definition::s_promotions_group_definition::s_runtime_timers_block)	TAG_REFL_PROPERTY(unknown)REFL_END
